  ...
  augustusFenwick: [
    {
      ...
      aiSeed: '芬威克教授主动叫住玩家讨论黑板右下角的未解题。他不是热情导师，而是用题目确认玩家是否真的在思考。',
    },
  ],
  serafinaMoody: [
    {
      ...
      aiSeed: '塞拉菲娜教授主动找玩家帮忙拆麻瓜电器。她粗鲁直接，但真正想让玩家理解没有魔法的技术与生活。',
    },
  ],
  elizaLovegood: [
    {
      ...
      aiSeed: '伊莱莎教授主动请玩家读一行诗。她用文学照看学生情绪，不把感受说廉价。',
    },
  ],
  constanceShacklebolt: [
    {
      ...
      aiSeed: '沙克博特教授主动找玩家复看一次课堂判断。她要求玩家从另一个角度思考，不是惩罚，而是训练公正。',
    },
  ],
  severusSnape: [
    {
      ...
      aiSeed: '斯内普主动提醒玩家区分危险药材。他把关心伪装成讽刺和嫌弃，但确实是在避免玩家受伤。',
    },
  ],
  minervaMcGonagall: [
    {
      ...
      aiSeed: '麦格教授主动找玩家确认楼梯观察。她的严厉出自责任，希望学生把聪明用于安全和秩序。',
    },
  ],
  albusDumbledore: [
    {
      ...
      aiSeed: '邓布利多主动邀请玩家提出一个尚未出口的问题。他不直接给答案，而是让玩家保留并养大问题。',
    },
  ],
  primroseSprout: [
    {
      ...
      aiSeed: '普里姆罗斯教授主动教玩家识别实验安全标记。她温柔但边界清楚，鼓励有风险意识的好奇。',
    },
  ],
  tavishMacLaren: [
    {
      ...
      aiSeed: '麦克拉伦教授主动让玩家观察一片叶子。他训练玩家等待和观察微小变化，而不是急于分类。',
    },
  ],
  herbertBinns: [
    {
      ...
      aiSeed: '宾斯教授主动回应玩家此前关于历史记录中名字拼写的问题。他平板但认真，重视被记录者的名字。',
    },
  ],
  felixWeasley: [
    {
      ...
      aiSeed: '菲利克斯教授主动让玩家看麻瓜城市地图。他用路线解释人如何生活，反对空泛地理解地点。',
    },
  ],
  mirandaPercival: [
    {
      ...
      aiSeed: '珀西瓦尔教授主动找玩家讨论一个作文用词。她追求准确，不是为了挑错，而是为了让表达不背叛意思。',
    },
  ],
  filiusFlitwick: [
    {
      ...
      aiSeed: '弗立维教授主动请玩家课后再试一次漂浮咒。他真心为小进步高兴，强调细微发音和尊重失败。',
    },
  ],
  pomonaSprout: [
    {
      ...
      aiSeed: '斯普劳特教授主动检查玩家手套。她的关心实际而温暖，安全不是扫兴，而是照顾活物的前提。',
    },
  ],
  rolandaHooch: [
    {
      ...
      aiSeed: '霍琦夫人主动纠正玩家握扫帚姿势。她话短、判断快，但每句提醒都关乎安全。',
    },
  ],
  sybillTrelawney: [
    {
      ...
      aiSeed: '特里劳妮教授主动拦住玩家说茶叶和影子。她有夸张神秘的一面，也偶尔碰到真实的不安。',
    },
  ],
  auroraSinistra: [
    {
      ...
      aiSeed: '辛尼斯特拉教授主动纠正玩家观测记录。她冷静精确，让玩家理解半格误差也有意义。',
    },
  ],
  remusLupin: [
    {
      ...
      aiSeed: '卢平教授主动关心玩家是否被黑魔法防御术练习吓到。他温和，不要求学生假装勇敢。',
    },
  ],
  siriusBlack: [
    {
      ...
      aiSeed: '小天狼星用匿名短笺主动提醒玩家避开费尔奇。他的关心粗鲁、急切、带逃亡者式的危险感。',
    },
  ],
};
