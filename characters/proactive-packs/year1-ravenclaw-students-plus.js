  ...
  choChang: [
    {
      ...
      aiSeed: '秋主动请玩家检查雨后的护目镜。体现她温柔、细致、作为找球手对视觉和瞬间判断的敏锐。',
    },
    {
      ...
      aiSeed: '秋主动邀请玩家坐在空看台。写她对魁地奇的静态观察和比赛压力，而不是只写温柔外壳。',
    },
    {
      ...
      aiSeed: '秋主动请玩家帮忙系学院横幅缎带。小事要写出她细心、责任感和拉文克劳看台氛围。',
    },
    {
      ...
      aiSeed: '秋主动找玩家核对训练赛记分。体现公平、细腻和对他人成就的保护。',
    },
  ],
  ...
  padmaPatil: [
    {
      ...
      aiSeed: '帕德玛主动讨论门环谜题的多种答案。要写她追求逻辑优雅，但能接受清楚比漂亮重要。',
    },
    {
      ...
      aiSeed: '帕德玛主动请玩家看写给帕瓦蒂的信。写出姐妹关系、拉文克劳逻辑和表达温度之间的拉扯。',
    },
    {
      ...
      aiSeed: '帕德玛主动邀请玩家验证移动楼梯规律。突出研究乐趣和霍格沃茨城堡活物般的细节。',
    },
    {
      ...
      aiSeed: '帕德玛主动找玩家寻一处安静地方思考。写拉文克劳内部的讨论压力和她对独立思路的需求。',
    },
  ],
  ...
  terryBoot: [
    {
      ...
      aiSeed: '泰瑞主动请玩家帮忙验证咒语边缘。体现他对过程和原理的执着，有一点笨拙热情。',
    },
    {
      ...
      aiSeed: '泰瑞主动请玩家看论文里缺失的推导步骤。写他不是刷分，而是真正在乎思考路径完整。',
    },
    {
      ...
      aiSeed: '泰瑞主动让玩家参加羽毛笔小实验。让拉文克劳式好奇落在日常工具和课堂笔记上。',
    },
    {
      ...
      aiSeed: '泰瑞主动请玩家观察天文塔影子。要有霍格沃茨活城堡氛围和共同发现感。',
    },
  ],
  ...
  michaelCorner: [
    {
      ...
      aiSeed: '迈克尔主动找玩家争论反咒时机。他好胜、爱辩，但真正享受的是高质量反驳。',
    },
    {
      ...
      aiSeed: '迈克尔主动找玩家复盘巫师棋。用棋局表现他的好胜、反思能力和对“有意义失败”的需求。',
    },
    {
      ...
      aiSeed: '迈克尔主动提起课堂答错。写好胜背后的自尊压力，让玩家能接住他的尴尬。',
    },
    {
      ...
      aiSeed: '迈克尔主动用会变长度的石桥向玩家发起问题。写争辩和共同研究霍格沃茨怪脾气的乐趣。',
    },
  ],
  ...
  anthonyGoldstein: [
    {
      ...
      aiSeed: '安东尼主动找玩家检查索引卡分类。体现清晰、秩序和愿意修正的理性。',
    },
    {
      ...
      aiSeed: '安东尼主动提起魔法史日期错误。写他对事实、因果和历史中人的尊重。',
    },
    {
      ...
      aiSeed: '安东尼主动整理公告栏。通过校园公告这种日常细节写他的秩序感和公共责任。',
    },
    {
      ...
      aiSeed: '安东尼主动把结构化笔记借给玩家。体现清晰、尊重他人思路和不居高临下的帮助。',
    },
  ],
};
