  ...
  seamus: [
    {
      ...
      aiSeed: '西莫主动请玩家帮他斟酌给母亲的信，想把魔咒课失败写得不那么吓人，又不想彻底撒谎。',
    },
    {
      ...
      aiSeed: '西莫主动请玩家陪他私下重试修复咒，他想证明自己不只是爆炸，也能稳定完成小咒语。',
    },
    {
      ...
      aiSeed: '西莫主动找玩家处理被火星燎坏的袖口，他用玩笑掩饰担心，但也想把失败变成能讲出口的经历。',
    },
    {
      ...
      aiSeed: '西莫主动想帮助一个魔咒失败的新生。他知道被笑的感觉，所以想用自己的失败给对方一个台阶。',
    },
  ],
  deanThomas: [
    {
      ...
      aiSeed: '迪安主动请玩家看魁地奇战术草图，并把麻瓜足球经验带入魔法世界。他想让两个世界都被认真看见。',
    },
    {
      ...
      aiSeed: '迪安主动请玩家看比赛海报配色。他不只是画背景装饰，而是在认真为学院气氛做东西。',
    },
    {
      ...
      aiSeed: '迪安主动给玩家看麻瓜家附近街道的素描。他在霍格沃茨适应得不错，但仍想保存旧世界的真实感。',
    },
    {
      ...
      aiSeed: '迪安主动把一张玩家的小速写送给玩家。重点是他观察日常里的安静瞬间，让玩家感到自己也被别人看见。',
    },
  ],
  leeJordan: [
    {
      ...
      aiSeed: '李·乔丹主动请玩家帮忙审解说稿。他追求好笑，但也关心话说出去后会落到谁身上。',
    },
    {
      ...
      aiSeed: '李·乔丹主动请求玩家帮忙做不太严重的恶作剧不在场证明。事件轻松，但要体现他和双胞胎的友情与机灵。',
    },
    {
      ...
      aiSeed: '李·乔丹主动让玩家坐到雨后空看台旁边。他不只是吵闹解说，也会安静地喜欢球场本身。',
    },
    {
      ...
      aiSeed: '李·乔丹主动承认比赛解说前有压力。玩家能看到他吵闹外表下对语言和比赛的责任感。',
    },
  ],
  percyWeasley: [
    {
      ...
      aiSeed: '珀西主动找玩家帮忙找迷路的一年级。他官僚严肃，但是真心担心学生安全。',
    },
    {
      ...
      aiSeed: '珀西主动向玩家展示或解释级长徽章的重要性。他想被认可为负责的人，而不是被笑成古板。',
    },
    {
      ...
      aiSeed: '珀西主动请求玩家帮他避开双胞胎的喧闹。他爱家人，但也会被家庭噪音压得需要喘息。',
    },
    {
      ...
      aiSeed: '珀西主动为玩家合理破例借书。他仍坚持规则，但开始理解规则是为了帮助人。',
    },
  ],
};
