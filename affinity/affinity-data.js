...
import { STAFF_YEAR1_BY_CHARACTER_CHATS, STAFF_YEAR1_BY_CHARACTER_ENCOUNTERS } from '../affinity-content/staff/year1/by-character/index.js';
...
mergeAffinityCharacterEnrichments(AFFINITY_CHARACTERS, withGradeRange(STAFF_YEAR1_BY_CHARACTER_ENCOUNTERS, { minGrade: 1, maxGrade: 1 }));
mergeAffinityCharacterEnrichments(AFFINITY_CHARACTERS, withGradeRange(STAFF_YEAR1_BY_CHARACTER_CHATS, { minGrade: 1, maxGrade: 1 }));
