  ...
  },
  {
    ...
    children: [
      ...
      { 
        ...
        name: "猪头酒吧", 
        icon: "🐗", 
        desc: "破败隐蔽的小众酒馆，秘密会面与地下交易聚集地", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
        shopId: "hog_head",
        shopType: "tavern_secret"
      },
      { 
        level: 3, 
        name: "佐科笑话店", 
        icon: "🃏", 
        desc: "恶作剧道具、整蛊玩具与趣味魔法小物专卖", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
      ...
      { 
        ...
        name: "德维斯与班斯商店", 
        icon: "🛒", 
        desc: "学生必备文具、魔法基础材料与日用杂货", 
        unlock: true, exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
      ...
      { 
        ...
        name: "霍格莫德邮局", 
        icon: "📮", 
        desc: "全域巫师邮政枢纽，收发信件、包裹与猫头鹰投递服务", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
        shopId: "hogsmeade_post",
        shopType: "service",
        isPost: true
      },
      { 
      ...
      { 
        ...
        name: "白鼬夫人茶屋", 
        icon: "☕", 
        desc: "精致下午茶、花草茶饮，女巫偏爱的静谧休憩小店", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
        shopId: "ermine_teahouse",
        shopType: "cafe"
      },
      { 
        level: 3, 
        name: "月桂魔材药房", 
        icon: "⚕️", 
        desc: "售卖魔药原料、疗伤药剂、解毒药水与魔法耗材", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
        shopId: "laurel_apothecary",
        shopType: "medicine"
      },
      { 
        level: 3, 
        name: "古卷二手书铺", 
        icon: "📚", 
        desc: "二手魔法典籍、古老卷轴、绝版教材与野生笔记", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
        shopId: "ancient_bookshop",
        shopType: "bookstore"
      },
      { 
        level: 3, 
        name: "毛羽宠物小店", 
        icon: "🐾", 
        desc: "猫头鹰饲料、宠物用品、魔法小动物零食与器具", 
        unlock: true, 
        exploreRate: 0, 
        needLevel: 1, 
        unlockTip: "限时解锁",
        shopId: "fur_feather_pet",
        shopType: "pet"
      },
      { 
        level: 3, 
...
export const materialLocations = {
  // 城堡地下室・地牢
  "魔药课教室": ["蛇牙", "带触角鼻涕虫", "火蜥蜴血", "流液草", "草蛉虫", "蚂蟥", "乌头", "瞌睡豆", "龙毒", "牛黄", "水蛭粉", "狐媚子粉", "巴波块茎脓水"],
  "城堡储藏室": ["罂粟籽", "缩皱无花果", "干荨麻", "薰衣草", "蝙蝠脾脏", "膨胀苔藓", "老龄苔藓", "石榴汁", "甘草根", "丁香", "桂皮"],
  "斯莱特林公共休息室": ["蛇毒", "黑魔法苔藓"],
  "密室": ["蛇毒", "黑魔法草", "夜影花", "诅咒花粉"],
  "地牢囚室": ["诅咒苔藓", "蝙蝠粪", "狼粪"],

  // 教学区域
  "校医院": ["白鲜", "白鲜花瓣", "甘菊", "红花瓣", "凤凰羽毛", "莫特拉鼠汁", "疗伤草"],
  "黑魔法防御术教室": ["豪猪刺", "绝音鸟羽毛", "比利威格虫针"],
  "家养小精灵厨房": ["蜂蜜水", "花蜜", "石榴汁", "肉豆蔻", "蛋奶草"],
  "魔法史教室": ["古代魔药书籍", "古籍墨粉", "古老草籽"],
  "占卜课教室": ["预言草", "星辰花蜜", "月露草"],
  
  // 户外和自然区域
  "草药课温室": ["干荨麻", "薄荷芽", "甘菊", "雏菊根", "荨麻", "薄荷", "蒲公英", "白鲜", 
                "蒲公英根", "金盏花", "雪滴花", "玫瑰花瓣", "日光花瓣", "日光花", "红花瓣", "曼德拉草",
                "火焰花", "柔顺草", "疙瘩藤", "咬人甘蓝", "米布米宝汁液", "腮囊草"],
  "黑湖湖畔": ["水仙根", "睡莲花粉", "露水", "月光露水", "雾隐花", "水仙根粉末"],
  "庭院草坪": ["雏菊根", "荨麻", "薄荷", "蒲公英", "日光花瓣", "日光花", "柔顺草", "苦艾草"],
  "打人柳树下": ["锋利草", "混乱草", "树人苔藓"],
  
  // 特殊地点
  "有求必应屋": ["失落的魔药材料", "传送草", "秘密草", "失传魔材", "稀有龙鳞"],
  "图书馆禁书区": ["诅咒苔藓", "誓言草", "秘密草", "黑魔法典籍残页", "暗影粉"],
  
  // 禁林区域
  "海格小屋旁小径": ["毛毛虫", "缬草根", "火灰蛇蛋"],
  "禁林边缘": ["苦艾草", "混乱草", "毛毛虫", "缬草根", "喷嚏草", "雾隐花", "野生薄荷"],
  "独角兽栖息地": ["独角兽角粉", "月光花蜜", "阳光花蜜", "独角兽毛", "独角兽血"],
  "马人部落领地": ["星辰花蜜", "预言草", "星象草", "月长石碎块"],
  "八眼巨蛛巢穴": ["蜘蛛毒液", "蝙蝠翅膀", "蝙蝠翅膀粉", "剧毒蘑菇", "蛛网粘液"],
  "黑暗魔法聚集地": ["龙血", "黑乌头", "诅咒苔藓", "蝙蝠血", "夜影花", "死神草", "暗影花", "暗影粉", "狼毒草"],
  
  // 霍格沃茨稀有区域
  "天文塔": ["月光露水", "星辰花蜜", "星尘粉", "月长石粉"],
  "魁地奇球场": ["闪电花", "幸运四叶草", "传送草", "火焰花", "飞行羽毛"],

  // ========== 霍格莫德村 非商店新地点 新增材料掉落 ==========
  "猪头酒吧": ["陈年魔酒残渣", "蝙蝠粪", "狼粪", "地下暗影苔藓"],
  "霍格莫德车站": ["铁路魔法苔藓", "旅行魔材", "闪电花残片", "龙粪"],
  "霍格莫德邮局": ["猫头鹰羽毛", "信使花蜜", "邮政苔藓", "羽毛粉"],
  "尖叫棚屋": ["狼毒草", "隐形苔藓"],
  "山间墓园": ["亡灵苔藓", "墓地花瓣", "夜影花残片", "诅咒花粉"],
  "溪流小巷居民区": ["家常魔材", "庭院花草", "邻里馈赠草药", "温和花瓣"],

  "古灵阁巫师银行": ["金粉", "妖精铁屑", "古币碎片", "龙鳞护甲残片"],
  "对角巷巷口": ["魔法砖粉", "破釜啤酒花", "旅行魔材", "城市苔藓"],
  "佛罗伦斯冰淇淋店": ["冰晶花蜜", "甜霜草", "奶油花瓣", "冻露水"],
  "翻倒巷暗巷": ["黑魔法苔藓", "暗影粉", "诅咒花粉", "可疑药渣"],
  "二手魔杖摊位": ["旧杖芯毛", "残缺杖木", "龙心弦碎片", "独角兽毛残段"],
  "黑市药剂交易点": ["龙毒", "黑乌头", "夜影花", "死神草", "暗影花"]
};

// 材料稀有度分类（补全原著核心材料，唯一定义）
const materialRarity = {
  common: [
    "干荨麻", "薄荷", "蒲公英", "荨麻", "露水", "花蜜", "蜂蜜水", 
    "薰衣草", "罂粟籽", "金盏花", "玫瑰花瓣", "日光花瓣", "日光花",
    "家常魔材", "庭院花草", "邻里馈赠草药", "温和花瓣",
    "魔法砖粉", "城市苔藓", "甜霜草", "奶油花瓣", "冻露水"
  ],
  uncommon: [
    "蛇牙", "薄荷芽", "甘菊", "雏菊根", "缩皱无花果", "水仙根", "白鲜", 
    "白鲜花瓣", "蚂蟥", "膨胀苔藓", "老龄苔藓", "缬草根", "苦艾草", 
    "毛毛虫", "喷嚏草", "雾隐花", "日光花", "红花瓣", "柔顺草",
    "蝙蝠粪", "狼粪", "古籍墨粉", "古老草籽", "月露草", "书页苔藓",
    "安抚草", "饲料魔材", "墓地花瓣", "夜影花残片", "诅咒花粉",
    "甘菊精华", "薰衣草蜜", "舒缓草", "花茶原料",
    "破釜啤酒花", "冰晶花蜜", "可疑药渣", "旧杖芯毛", "残缺杖木"
  ],
  rare: [
    "带触角鼻涕虫", "火蜥蜴血", "睡莲花粉", "蜘蛛毒液", "蝙蝠脾脏", 
    "流液草", "草蛉虫", "豪猪刺", "瞌睡豆", "乌头", "石榴汁", 
    "曼德拉草", "剧毒蘑菇", "龙毒", "水蛭粉", "狐媚子粉", "巴波块茎脓水",
    "疙瘩藤", "咬人甘蓝", "米布米宝汁液", "腮囊草", "火灰蛇蛋", 
    "树人苔藓", "蛛网粘液", "甘草根", "丁香", "桂皮", "肉豆蔻", 
    "蛋奶草", "星尘粉", "月长石碎块", "飞行羽毛", "疗伤草", 
    "解毒草", "黑魔法苔藓", "黑魔法典籍残页",
    "陈年魔酒残渣", "地下暗影苔藓", "铁路魔法苔藓", "旅行魔材", 
    "闪电花残片", "龙粪", "猫头鹰羽毛", "信使花蜜", "邮政苔藓", 
    "羽毛粉", "疗伤花粉", "基础魔药耗材", "古老魔材", "宠物羽毛", 
    "小动物鳞片", "亡灵苔藓",
    "金粉", "妖精铁屑", "古币碎片", "龙鳞护甲残片", "龙心弦碎片", "独角兽毛残段"
  ],
  very_rare: [
    "独角兽角粉", "龙血", "蛇毒", "暗影花", "黑乌头", "死神草", 
    "狼毒草", "星辰粉", "牛黄", "凤凰羽毛", "绝音鸟羽毛", 
    "比利威格虫针", "莫特拉鼠汁", "独角兽毛", "独角兽血", "夜影花",
    "失落的魔药材料", "传送草", "秘密草", "失传魔材", "稀有龙鳞",
    "隐形苔藓", "狼毒草", "预言草", "星辰花蜜", "月光花蜜" // 稀有特殊材料
  ]
};

// 材料对应的表情符号系统（补全所有缺失材料，唯一定义）
...
export function getMatEmoji(materialName) {
  return materialEmojis[materialName] || "🌿";
}
