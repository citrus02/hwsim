...
export const potions = [
  ...
  },
  {
    ...
    grade: "自学/私人配方",
    effect: "使毛发疯狂生长、直立",
    description: "基础刺激类魔药，常用于恶作剧，非霍格沃茨正规课程内容",
  ...
  },
  {
    ...
    grade: "自学/私人配方",
    effect: "增加年龄",
    description: "可用于突破年龄限制（如火焰杯），非霍格沃茨正规课程内容",
  ...
  },
  {
    ...
    grade: "自学/私人配方",
    effect: "快速补血、治疗失血",
    description: "中级治疗魔药，非霍格沃茨正规课程内容",
  ...
  // 六年级～N.E.W.T. 高级
  {
    ...
    effect: "强效昏睡，接近假死",
    description: "斯内普原创改良，哈利凭课堂笔记成功调制",
    materials: ["缬草根", "水仙根粉末", "瞌睡豆", "乌头"],
    quantities: [2, 2, 1, 1],
    icon: "⚗️",
    color: "#404080",
    colorName: "深靛蓝色",
    unlockCondition: "六年级课堂笔记解锁",
  ...
  },
  {
    ...
    description: "课堂笔记独家改良版",
    materials: ["瞌睡豆", "水仙根粉末", "缬草根", "银粉"],
    quantities: [1, 2, 2, 1],
    icon: "🖤",
    color: "#383868",
    colorName: "深蓝",
    unlockCondition: "课堂笔记解锁",
