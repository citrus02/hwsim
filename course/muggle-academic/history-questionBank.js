...
export const questionBank = [
  ...
  { lesson: 1, title: "诺曼征服1066", questions: [
    ...
    { type: "choice", difficulty: 1, text: "在黑斯廷斯战役中，诺曼军队取胜的关键战术是什么？", options: ["A. 人数远超撒克逊军队", "B. 骑兵佯装撤退诱敌出击后回身包抄", "C. 使用长弓远程射击", "D. 夜袭撒克逊营地"], answer: "B", knowledgePoint: "黑斯廷斯战役战术", analysis: "诺曼骑兵佯装撤退，诱使撒克逊盾墙散开追击，然后回身包抄——一个假动作赢得了一场战争。" },
    ...
    { type: "choice", difficulty: 2, text: "末日审判书（Domesday Book）的主要作用是什么？", options: ["A. 记录军事胜利的编年史", "B. 进行土地和人口普查以便征税", "C. 制定英格兰统一法律", "D. 记录贵族世系"], answer: "B", knowledgePoint: "末日审判书", analysis: "1086年，威廉一世派官员走遍英格兰记录每一块土地的主人和人口，用于确定税基。" },
  ...
  { lesson: 2, title: "封建制度", questions: [
    ...
    { type: "choice", difficulty: 1, text: "在封建金字塔中，处于最底层的是：", options: ["A. 国王", "B. 大贵族", "C. 骑士", "D. 农奴"], answer: "D", knowledgePoint: "封建等级", analysis: "农奴在封建金字塔的最底层，耕种土地养活所有人，权利最少义务最多。" },
    ...
    { type: "choice", difficulty: 2, text: "封建关系中封君对封臣的主要义务是什么？", options: ["A. 提供教育和培训", "B. 提供保护和土地", "C. 支付工资", "D. 授予爵位"], answer: "B", knowledgePoint: "封君义务", analysis: "封君有义务保护封臣的人身安全和土地权益，破坏契约的一方在中世纪是不名誉的。" },
  ...
  { lesson: 3, title: "黑死病", questions: [
    ...
    { type: "choice", difficulty: 1, text: "黑死病主要通过什么途径从中亚传播到欧洲？", options: ["A. 军队行军路线", "B. 贸易商船和商队", "C. 候鸟迁徙", "D. 朝圣者步行路线"], answer: "B", knowledgePoint: "黑死病传播途径", analysis: "老鼠藏在商船的货舱里，跳蚤吸了病鼠的血再咬人——黑死病沿着丝绸之路和地中海商路传播。" },
    ...
    { type: "choice", difficulty: 2, text: "黑死病后农奴的议价能力提高的根本原因是什么？", options: ["A. 国王颁布了保护农奴的法律", "B. 劳动力变得稀缺", "C. 教会站在农奴一边", "D. 贵族主动放弃特权"], answer: "B", knowledgePoint: "劳动力稀缺", analysis: "人口减少导致劳动力供不应求，农奴可以谈条件甚至离开领主的庄园。" },
  ...
  { lesson: 4, title: "教会的权力", questions: [
    ...
    { type: "choice", difficulty: 1, text: "中世纪教堂在社区中扮演的角色不包括以下哪项？", options: ["A. 宗教活动的中心", "B. 社区集会的场所", "C. 教育知识的中心", "D. 国王的行政办公地"], answer: "D", knowledgePoint: "教堂的社会角色", analysis: "教堂是中世纪人出生受洗、结婚、告解、集会、受教育甚至避难的地方，覆盖了从生到死的全部需求。" },
    { type: "choice", difficulty: 2, text: "1077年卡诺莎事件中，亨利四世在雪地里站了三天请求教皇宽恕，根本原因是：", options: ["A. 他犯了杀人罪", "B. 被开除教籍使他失去统治合法性", "C. 他想参加宗教仪式", "D. 他想请求教皇帮助打仗"], answer: "B", knowledgePoint: "卡诺莎事件", analysis: "被开除教籍意味着国王失去了统治的宗教合法性——臣民无需服从他。亨利四世别无选择，只能在卡诺莎城堡外的雪地里站了三天请求赦免。" },
    { type: "choice", difficulty: 2, text: "修道院在中世纪文化中的最重要贡献是什么？", options: ["A. 建造宏伟的教堂", "B. 手抄和保存古代知识文献", "C. 组织十字军东征", "D. 管理封建土地"], answer: "B", knowledgePoint: "修道院的文化贡献", analysis: "修道院里的抄写员日复一日地伏案抄写古代文献——包括圣经和古典著作——在印刷术发明前，这是知识传承的唯一方式。" },
  ...
  { lesson: 5, title: "大宪章与议会起源", questions: [
    ...
    { type: "choice", difficulty: 1, text: "被称为'失地王'的英格兰国王是：", options: ["A. 理查一世", "B. 约翰国王", "C. 亨利三世", "D. 爱德华一世"], answer: "B", knowledgePoint: "约翰国王", analysis: "约翰国王因在法国战争中丢失了大量领土而被称为'失地王'，他的暴政直接导致了贵族反叛和大宪章的签署。" },
    ...
    { type: "choice", difficulty: 2, text: "大宪章第39条确立了什么重要原则？", options: ["A. 国王有权任意征税", "B. 不经合法审判不得监禁任何人", "C. 贵族可以随时罢免国王", "D. 教会拥有最高权力"], answer: "B", knowledgePoint: "正当程序", analysis: "第39条规定任何自由民非经同级贵族依法审判或经国法判决，不得被逮捕、监禁或没收财产——这是'正当程序'原则的源头。" },
  ...
  { lesson: 6, title: "十字军东征", questions: [
    ...
    { type: "choice", difficulty: 1, text: "教皇乌尔班二世在哪一年号召了第一次十字军东征？", options: ["A. 1095年", "B. 1195年", "C. 1295年", "D. 1395年"], answer: "A", knowledgePoint: "第一次十字军", analysis: "1095年，教皇乌尔班二世在克莱芒发表了著名的演讲，号召信徒去东方收复圣地。" },
    ...
    { type: "choice", difficulty: 2, text: "第四次十字军东征最荒唐之处在于：", options: ["A. 还没出发就解散了", "B. 攻打了同属基督教世界的君士坦丁堡", "C. 全军在海上遇难", "D. 士兵全部叛变"], answer: "B", knowledgePoint: "第四次十字军", analysis: "第四次十字军没有去耶路撒冷，而是攻打了同样是基督教城市的君士坦丁堡，暴露了十字军运动背后的政治和经济动机。" },
  ...
  { lesson: 7, title: "文艺复兴", questions: [
    ...
    { type: "choice", difficulty: 1, text: "文艺复兴时期最重要的赞助家族是：", options: ["A. 美第奇家族", "B. 波吉亚家族", "C. 斯福尔扎家族", "D. 哈布斯堡家族"], answer: "A", knowledgePoint: "美第奇家族", analysis: "佛罗伦萨的美第奇家族是欧洲最富有的银行家族，赞助了达芬奇、米开朗基罗、拉斐尔等文艺复兴巨匠。" },
    ...
    { type: "choice", difficulty: 2, text: "为什么文艺复兴首先发生在意大利？", options: ["A. 意大利国王的支持", "B. 地中海贸易带来的财富和古典传统", "C. 意大利的人口最多", "D. 欧洲其他地方都被战争摧毁了"], answer: "B", knowledgePoint: "文艺复兴在意大利", analysis: "意大利城邦控制地中海贸易积累了大量财富，同时拥有古罗马的古典文化传统——财富加古典传统培育了文艺复兴的土壤。" },
  ...
  { lesson: 8, title: "印刷术革命", questions: [
    ...
    { type: "choice", difficulty: 1, text: "古腾堡印刷机最重要的技术创新是什么？", options: ["A. 使用了彩色墨水", "B. 可移动金属活字可重复使用", "C. 可以双面印刷", "D. 采用了蒸汽动力"], answer: "B", knowledgePoint: "活字印刷", analysis: "古腾堡的核心创新是把每个字母做成独立的金属活字，排好一页印完拆掉再用，效率比手抄提高了数百倍。" },
    ...
    { type: "choice", difficulty: 2, text: "1450年到1500年间，欧洲书籍总量从约三万本增长到了多少？", options: ["A. 约九万本", "B. 约九十万本", "C. 约九百万本", "D. 约九千万本"], answer: "C", knowledgePoint: "书籍数量增长", analysis: "五十年间欧洲书籍总量从约三万本手抄书增长到约九百万本印刷品——三百倍的增长。" },
  ...
  { lesson: 9, title: "地理大发现", questions: [
    ...
    { type: "choice", difficulty: 1, text: "哥伦布最初航行的目的是什么？", options: ["A. 证明地球是圆的", "B. 寻找通往东方的新航路", "C. 发现新大陆", "D. 捕鱼和探险"], answer: "B", knowledgePoint: "哥伦布的航行目的", analysis: "哥伦布想从西边绕过地球背面到达日本和中国，他严重低估了地球的周长，却因此发现了美洲。" },
    { type: "choice", difficulty: 2, text: "地理大发现的动机是：", options: ["A. 科学探索", "B. 寻找新航路", "C. 逃避战乱", "D. 传播宗教"], answer: "B", knowledgePoint: "地理大发现的动机", analysis: "欧洲人寻找通往东方的新航路以获取香料和财富，这是地理大发现的主要动机。" },
    { type: "choice", difficulty: 2, text: "'哥伦布大交换'中从美洲传入欧洲的重要作物是：", options: ["A. 小麦和水稻", "B. 马铃薯和玉米", "C. 甘蔗和香蕉", "D. 橄榄和葡萄"], answer: "B", knowledgePoint: "哥伦布大交换", analysis: "马铃薯、玉米、番茄、烟草等作物从美洲传入欧洲，彻底改变了欧洲的农业和饮食结构。" },
  ...
  { lesson: 10, title: "宗教改革", questions: [
    ...
    { type: "choice", difficulty: 1, text: "马丁·路德的核心神学主张是什么？", options: ["A. 教皇至上", "B. 因信称义——信仰本身即是救赎", "C. 废除一切宗教", "D. 建立新的教皇制度"], answer: "B", knowledgePoint: "因信称义", analysis: "路德认为得救靠的是信仰和上帝的恩典，而不是购买赎罪券——这直接挑战了教会的权威和收入来源。" },
    ...
    { type: "choice", difficulty: 2, text: "宗教改革后基督教分裂出哪个不属于新教的教派？", options: ["A. 路德宗", "B. 加尔文宗", "C. 圣公会（英国国教）", "D. 东正教"], answer: "D", knowledgePoint: "新教教派", analysis: "东正教在1054年基督教大分裂时就已与天主教分裂，远早于宗教改革。宗教改革产生的新教教派是路德宗、加尔文宗和圣公会等。" },
  ...
  { lesson: 11, title: "都铎王朝崛起", questions: [
    ...
    { type: "choice", difficulty: 1, text: "玫瑰战争是哪两个家族的斗争？", options: ["A. 约克和兰开斯特", "B. 都铎和斯图亚特", "C. 金雀花和诺曼", "D. 安茹和卡佩"], answer: "A", knowledgePoint: "玫瑰战争", analysis: "玫瑰战争是约克家族（白玫瑰）和兰开斯特家族（红玫瑰）为争夺王位进行的长达30年的战争。" },
    { type: "choice", difficulty: 2, text: "都铎玫瑰象征了什么？", options: ["A. 英格兰的国花", "B. 红白玫瑰的合并——兰开斯特和约克的和解", "C. 血腥战争的标志", "D. 法国王室的标志"], answer: "B", knowledgePoint: "都铎玫瑰", analysis: "亨利七世娶了约克家族的伊丽莎白，把红玫瑰和白玫瑰合并成了一朵都铎玫瑰——象征着王位战争以婚姻画上句号。" },
    { type: "choice", difficulty: 2, text: "亨利七世巩固王权的策略不包括以下哪项？", options: ["A. 通过联姻巩固和平", "B. 整顿财政精打细算", "C. 解散议会实行独裁", "D. 削弱贵族势力"], answer: "C", knowledgePoint: "亨利七世的策略", analysis: "都铎国王们不绕过议会——他们控制议会通过立法巩固权力。亨利七世从未解散议会。" },
    { type: "choice", difficulty: 3, text: "都铎王朝的特点是：", options: ["A. 王权削弱", "B. 专制加强", "C. 民主兴起", "D. 教会独立"], answer: "B", knowledgePoint: "都铎专制", analysis: "都铎王朝加强了王权，建立了强大的中央集权，议会成为国王巩固权力的工具。" },
  ...
  { lesson: 12, title: "亨利八世", questions: [
    ...
    { type: "choice", difficulty: 1, text: "亨利八世最渴望的子嗣是一个：", options: ["A. 女儿", "B. 儿子", "C. 双胞胎", "D. 没有偏好"], answer: "B", knowledgePoint: "男性继承人", analysis: "亨利八世需要一个合法的男性继承人来确保都铎王朝的延续，这是他与罗马教廷决裂的根本动因。" },
    ...
    { type: "choice", difficulty: 2, text: "解散修道院的最直接效果是什么？", options: ["A. 改善了僧侣的生活", "B. 充实了王室财政并削弱了教会势力", "C. 促进了宗教宽容", "D. 提高了教育水平"], answer: "B", knowledgePoint: "解散修道院的效果", analysis: "约八百多座修道院的土地和财富被王室没收，王室成为英格兰最大的地主，同时卖地给新贵族使其成为宗教改革的既得利益者。" },
    { type: "choice", difficulty: 3, text: "亨利八世宗教改革的性质是：", options: ["A. 神学改革——他真心信奉新教", "B. 政治决裂——权力和金钱的争夺而非信仰之争", "C. 社会革命——推翻封建制度", "D. 文化运动——复兴古典文化"], answer: "B", knowledgePoint: "宗教改革的性质", analysis: "亨利八世一辈子都认为自己是好天主教徒，他的宗教改革不涉及神学——他关心的是把教皇的权力和教会的财富夺到自己手里。" },
  ...
  { lesson: 13, title: "伊丽莎白一世时代", questions: [
    ...
    { type: "choice", difficulty: 1, text: "英国击败西班牙无敌舰队是在哪一年？", options: ["A. 1588年", "B. 1688年", "C. 1788年", "D. 1888年"], answer: "A", knowledgePoint: "无敌舰队", analysis: "1588年，英国海军用火攻船战术击败了西班牙无敌舰队，确立了海上霸权。" },
    { type: "choice", difficulty: 2, text: "伊丽莎白一世宗教和解的核心策略是什么？", options: ["A. 恢复天主教", "B. 走温和中间路线", "C. 实行极端新教", "D. 彻底取消宗教"], answer: "B", knowledgePoint: "宗教和解", analysis: "伊丽莎白的解决方案是走中间路线——教义靠拢新教，仪式上保留天主教传统，一句话：'我不窥探灵魂的窗户。'" },
    { type: "choice", difficulty: 2, text: "英国击败西班牙无敌舰队最关键的因素是什么？", options: ["A. 英国军队人数远超西班牙", "B. 火攻船战术和风暴的帮助", "C. 西班牙舰队主动撤退", "D. 法国的军事援助"], answer: "B", knowledgePoint: "无敌舰队覆灭", analysis: "英国海军用火攻船冲散了西班牙舰队的密集阵型，随后风暴把零散的西班牙战舰吹向北海——出发时130艘船，回来的不到一半。" },
    { type: "choice", difficulty: 3, text: "伊丽莎白时代的文化成就不包括：", options: ["A. 莎士比亚的戏剧", "B. 培根的哲学", "C. 牛顿的科学发现", "D. 马洛的文学创作"], answer: "C", knowledgePoint: "伊丽莎白时代文化", analysis: "牛顿的科学发现发生在17世纪后期的英国，晚于伊丽莎白时代。" },
  ...
  { lesson: 14, title: "清教徒革命", questions: [
    ...
    { type: "choice", difficulty: 1, text: "查理一世关于王权的核心主张是？", options: ["A. 王权来自议会", "B. 君权神授——国王只对上帝负责", "C. 王权来自人民", "D. 国王应该退位"], answer: "B", knowledgePoint: "君权神授", analysis: "查理一世相信国王的权力来自上帝，而非议会——这直接导致了与议会的冲突。" },
    ...
    { type: "choice", difficulty: 2, text: "新模范军击败国王军队的核心原因是什么？", options: ["A. 人数远远多于国王军队", "B. 严格的纪律和清教徒的信仰", "C. 使用了更先进的武器", "D. 法国军队的援助"], answer: "B", knowledgePoint: "新模范军", analysis: "克伦威尔招募的是清教徒志愿者，他们不抢劫不酗酒、在战场上歌唱圣经诗篇冲锋——这种精神力量比雇佣兵强大得多。" },
  ...
  { lesson: 15, title: "克伦威尔与共和国", questions: [
    ...
    { type: "choice", difficulty: 1, text: "斯图亚特复辟是在哪一年？", options: ["A. 1660年", "B. 1670年", "C. 1680年", "D. 1690年"], answer: "A", knowledgePoint: "斯图亚特复辟", analysis: "1660年，查理二世回到英国，斯图亚特王朝复辟，结束了共和国时期。" },
    { type: "choice", difficulty: 2, text: "克伦威尔的共和国有何内在矛盾？", options: ["A. 经济太繁荣了", "B. 他推翻了国王却建立了军事独裁", "C. 他把权力交给了议会", "D. 他恢复了天主教"], answer: "B", knowledgePoint: "共和国的矛盾", analysis: "革命推翻了君主制——但克伦威尔作为护国公的权力超过了任何都铎国王。他以自由的名义夺权却以独裁的方式统治。" },
    { type: "choice", difficulty: 2, text: "斯图亚特王朝为什么能够成功复辟？", options: ["A. 查理二世率军征服了英格兰", "B. 共和国陷入混乱，人们渴望稳定", "C. 法国国王强迫英格兰恢复君主制", "D. 克伦威尔临终前要求复辟"], answer: "B", knowledgePoint: "复辟原因", analysis: "克伦威尔死后，其子软弱无能，将军们争权夺利，共和国在两年内瓦解——人们开始怀念君主制，至少有个明确的权威。" },
  ...
  { lesson: 16, title: "蒸汽机", questions: [
    ...
    { type: "choice", difficulty: 1, text: "瓦特对蒸汽机最重要的改进是什么？", options: ["A. 提高了锅炉的温度", "B. 增加了独立的冷凝器", "C. 把蒸汽机做得更小", "D. 改用了石油作为燃料"], answer: "B", knowledgePoint: "独立冷凝器", analysis: "瓦特把冷凝过程移到气缸外，使气缸保持恒温，燃料消耗降到原来的四分之一。" },
    ...
    { type: "choice", difficulty: 2, text: "瓦特改良蒸汽机前，纽科门蒸汽机最大的问题是什么？", options: ["A. 无法产生足够的动力", "B. 气缸反复冷却再加热浪费大量热能", "C. 体积太大无法搬运", "D. 噪音太大影响操作"], answer: "B", knowledgePoint: "纽科门机的缺陷", analysis: "纽科门的问题是在气缸里交替注入蒸汽和冷水——气缸刚热就被冷却了，燃料利用率极低。" },
  ...
  { lesson: 17, title: "工厂制度", questions: [
    ...
    { type: "choice", difficulty: 1, text: "工厂制度取代手工工场的前提是蒸汽机的普及提供了集中的动力来源。这种说法：", options: ["A. 正确，动力集中是工厂制度的基础", "B. 错误，工厂制度不需要蒸汽机", "C. 完全无关", "D. 蒸汽机让工厂变小了"], answer: "A", knowledgePoint: "动力与工厂", analysis: "蒸汽机让工厂不再依赖水力——可以在城市里建大型工厂，工人集中到工厂工作。" },
    ...
    { type: "choice", difficulty: 2, text: "早期工厂的工作时间通常是多少？", options: ["A. 8小时", "B. 10小时", "C. 14-16小时", "D. 按需安排灵活工时"], answer: "C", knowledgePoint: "工厂工作时间", analysis: "早期工厂每天工作14到16个小时是常态，而且经常包括童工——1833年工厂法才把9-13岁儿童的工时限制在9小时。" },
  ...
  { lesson: 18, title: "城市化", questions: [
    ...
    { type: "choice", difficulty: 1, text: "曼彻斯特是因什么而崛起？", options: ["A. 农业", "B. 纺织业", "C. 渔业", "D. 采矿业"], answer: "B", knowledgePoint: "曼彻斯特", analysis: "曼彻斯特因纺织业的发展从一个小镇变成了工业中心，是工业革命的典型城市。" },
    { type: "choice", difficulty: 2, text: "工业革命时期的城市化带来了哪些严重问题？", options: ["A. 人口不足", "B. 污染、拥挤和疾病传播", "C. 工资过高", "D. 农业衰落"], answer: "B", knowledgePoint: "城市化问题", analysis: "城市人口急剧膨胀但基础设施跟不上——没有下水道、没有垃圾清运、没有清洁饮水——传染病在拥挤的贫民窟里迅速传播。" },
    { type: "choice", difficulty: 2, text: "以下哪项不是工业革命期间城市快速增长的主要原因？", options: ["A. 工厂提供了大量就业岗位", "B. 圈地运动使农村失去土地的农民涌入城市", "C. 城市生活环境优于农村", "D. 交通运输的改善使人口流动更加便利"], answer: "C", knowledgePoint: "城市增长原因", analysis: "讽刺的是，当时城市的生活环境（污染、拥挤、疾病）远差于农村——但农民已经没有土地可种了，工厂是他们唯一的出路。" },
  ...
  { lesson: 19, title: "工人运动", questions: [
    ...
    { type: "choice", difficulty: 1, text: "工会的主要职能是什么？", options: ["A. 维护资本家利益", "B. 维护工人权益", "C. 破坏生产", "D. 反对改革"], answer: "B", knowledgePoint: "工会职能", analysis: "工会组织工人争取更好的工资和工作条件，维护工人的权益。" },
    { type: "choice", difficulty: 2, text: "工人运动的结果是：", options: ["A. 没有任何改变", "B. 推动社会改革", "C. 推翻资本主义", "D. 回到封建制度"], answer: "B", knowledgePoint: "工人运动的影响", analysis: "工人运动推动了社会改革，如工厂法的制定，改善了工人的生活和工作条件。" },
    { type: "choice", difficulty: 2, text: "1833年英国工厂法的主要作用是：", options: ["A. 取消所有工厂", "B. 限制童工的工作时间", "C. 提高成年工人的工资", "D. 实行8小时工作制"], answer: "B", knowledgePoint: "1833年工厂法", analysis: "1833年工厂法规定9-13岁儿童每天工作不超过9小时，13-18岁不超过12小时——这是英国第一次用法律限制童工劳动，尽管远不完善，但迈出了第一步。" },
    { type: "choice", difficulty: 3, text: "宪章运动的三次请愿都被议会否决了，但其诉求在后来的几十年里逐步实现。这说明了什么？", options: ["A. 宪章运动彻底失败了", "B. 社会变革有时需要跨越数十年的渐进斗争", "C. 工人阶级不该通过政治途径斗争", "D. 英国当时已经是民主国家"], answer: "B", knowledgePoint: "宪章运动的意义", analysis: "宪章运动的六项要求最终在20世纪初基本实现——历史经常如此：运动在当下'失败'，却在长时段中'成功'。" },
  ...
  { lesson: 20, title: "维多利亚时代", questions: [
    ...
    { type: "choice", difficulty: 1, text: "维多利亚时代被称为'矛盾的时代'，以下哪组对比最能体现这种矛盾？", options: ["A. 工党vs保守党", "B. 工业繁荣与贫困并存", "C. 英国vs法国", "D. 城市vs农村"], answer: "B", knowledgePoint: "矛盾的时代", analysis: "维多利亚时代一方面工业进步、科学繁荣、帝国扩张，另一方面贫富差距巨大、童工普遍、城市贫民窟触目惊心——进步与矛盾并存。" },
    ...
    { type: "choice", difficulty: 2, text: "狄更斯的小说对维多利亚时代最大的贡献是什么？", options: ["A. 娱乐大众", "B. 揭露社会黑暗并推动了社会改革", "C. 歌颂大英帝国", "D. 推广标准英语"], answer: "B", knowledgePoint: "狄更斯的意义", analysis: "狄更斯的小说《雾都孤儿》《艰难时世》等逼真地描绘了贫民窟和童工的苦难，让中产阶级读者无法再视而不见——小说成为了推动社会改革的舆论力量。" },
  ...
  { lesson: 21, title: "大英帝国", questions: [
    ...
    { type: "choice", difficulty: 1, text: "大英帝国鼎盛时领土面积约占世界的：", options: ["A. 四分之一", "B. 三分之一", "C. 二分之一", "D. 十分之一"], answer: "A", knowledgePoint: "帝国规模", analysis: "大英帝国领土约三千五百万平方公里，占世界陆地面积的四分之一——人类历史上面积最大的帝国。" },
    ...
    { type: "choice", difficulty: 2, text: "英国统治印度和统治加拿大的方式有何不同？", options: ["A. 没有区别", "B. 印度由英国政府直接统治，加拿大是自治领", "C. 印度是自治领，加拿大是直辖殖民地", "D. 两国都由东印度公司管理"], answer: "B", knowledgePoint: "帝国统治方式", analysis: "英国用不同方式管理不同的殖民地——印度由英国政府直接统治，加拿大和澳大利亚是自治领，拥有自己的议会。" },
  ...
  { lesson: 22, title: "殖民地的声音", questions: [
    ...
    { type: "choice", difficulty: 1, text: "殖民教育的意外后果是：", options: ["A. 彻底消灭了当地文化", "B. 培养了独立运动的领袖", "C. 所有人都认同殖民统治", "D. 没有产生任何影响"], answer: "B", knowledgePoint: "殖民教育的悖论", analysis: "英国推行英语教育本意是培养听话的本地精英，但这些人学到了自由平等的理念后，反而成为了独立运动的领袖。" },
    ...
    { type: "choice", difficulty: 2, text: "殖民地精英在宗主国学习后回国领导独立运动，这一现象被称为帝国主义最大的讽刺。讽刺之处在于：", options: ["A. 殖民者无意中教给了被殖民者反抗的工具", "B. 独立运动其实没有成功", "C. 精英们在国外学坏了", "D. 殖民者早就预料到了"], answer: "A", knowledgePoint: "帝国的掘墓人", analysis: "殖民者亲手培养了反抗自己的人——甘地、尼赫鲁、恩克鲁玛都在伦敦学到了自由和平等的理念，然后回国用这些理念反对殖民统治。" },
  ...
  { lesson: 23, title: "奴隶贸易与废除", questions: [
    ...
    { type: "choice", difficulty: 1, text: "三角贸易中被称为'中间通道'的是哪一段？", options: ["A. 欧洲到非洲", "B. 非洲到美洲——运送奴隶", "C. 美洲到欧洲", "D. 欧洲到美洲"], answer: "B", knowledgePoint: "中间通道", analysis: "中间通道是从非洲到美洲横跨大西洋的一段航程——奴隶被锁在狭窄的舱室里，约15%的人在途中死亡。" },
    ...
    { type: "choice", difficulty: 2, text: "英国废奴运动领袖威廉·威尔伯福斯在议会中推动废奴法案用了约多少年？", options: ["A. 5年", "B. 10年", "C. 20年", "D. 50年"], answer: "C", knowledgePoint: "威尔伯福斯", analysis: "威尔伯福斯从1787年开始在议会推动废奴法案，直到1807年才通过——整整二十年的坚持。" },
  ...
  { lesson: 24, title: "印度", questions: [
    ...
    { type: "choice", difficulty: 1, text: "印度独立是在哪一年？", options: ["A. 1947年", "B. 1957年", "C. 1967年", "D. 1977年"], answer: "A", knowledgePoint: "印度独立", analysis: "1947年，印度获得独立，结束了英国的殖民统治。" },
    { type: "choice", difficulty: 2, text: "印巴分治的原因是：", options: ["A. 地理因素", "B. 宗教差异", "C. 经济矛盾", "D. 外部压力"], answer: "B", knowledgePoint: "印巴分治", analysis: "印度教徒和穆斯林之间的宗教差异导致了印巴分治，印度和巴基斯坦分别独立。" },
    { type: "choice", difficulty: 2, text: "甘地的'食盐进军'抗议的是什么？", options: ["A. 英国禁止印度人吃盐", "B. 英国对盐的垄断和税收", "C. 盐的价格太高", "D. 英国人不让印度人晒盐"], answer: "B", knowledgePoint: "食盐进军", analysis: "盐是每个印度人的日常必需品，但法律规定只能买英国垄断的高价盐。甘地步行四百公里到海边自己制盐——打破了法律也点燃了全国的反抗。" },
    { type: "choice", difficulty: 3, text: "印巴分治的代价约有多少人死于暴力冲突？", options: ["A. 1万人", "B. 10万人", "C. 约100万-200万人", "D. 1000万人"], answer: "C", knowledgePoint: "分治的代价", analysis: "印巴分治导致约1500万人跨越新边界，约100万到200万人在暴力冲突中死亡，是人类历史上规模最大的人口迁移之一。" },
  ...
  { lesson: 25, title: "非洲瓜分", questions: [
    ...
    { type: "choice", difficulty: 1, text: "柏林会议最令人震惊的事实是：", options: ["A. 会议持续了两年", "B. 没有一个非洲人被邀请参加", "C. 所有国家都同意和平瓜分", "D. 会议在非洲举行"], answer: "B", knowledgePoint: "柏林会议的无非洲人", analysis: "十四个欧洲国家坐在一起讨论如何瓜分非洲——没有一位非洲人在场。被瓜分的对象连发言权都没有。" },
    ...
    { type: "choice", difficulty: 2, text: "柏林会议划定的非洲边界造成了什么长期后果？", options: ["A. 非洲从此和平稳定", "B. 切断了部落和民族，成为冲突的重要根源", "C. 边界后来被重新划分", "D. 没有产生任何影响"], answer: "B", knowledgePoint: "柏林会议的长期影响", analysis: "殖民者走了但边界留了下来——直线把同一民族分到了不同国家，把世仇关进了同一个国家。卢旺达的种族灭绝和尼日利亚的内战都与此有关。" },
    ...
    { type: "open", text: "柏林会议在地图上用尺子画了几条直线，就瓜分了一个大陆。今天非洲的许多冲突仍然可以追溯到这些直线。请分析：为什么一百多年前画在地图上的线，至今仍在塑造现实？", scoringPoints: ["能具体说明柏林会议如何用直线划分非洲", "能举例说明这些直线造成的当代冲突（如卢旺达、尼日利亚）", "能分析国际政治中'边界不可改变'原则的两面性"], maxScore: 6 }
  ]},
  ...
  { lesson: 26, title: "民族主义", questions: [
    ...
    { type: "choice", difficulty: 1, text: "巴尔干被称为'火药桶'的主要原因是：", options: ["A. 这里盛产火药", "B. 多民族杂居和外部大国的争夺", "C. 巴尔干的天气容易引发火灾", "D. 这里的山脉是火山"], answer: "B", knowledgePoint: "火药桶的原因", analysis: "塞尔维亚人、克罗地亚人、波斯尼亚人、保加利亚人等多个民族挤在同一片土地上，加上奥匈帝国和俄国的争夺——一点火星就能点燃。" },
    ...
    { type: "choice", difficulty: 2, text: "塞尔维亚在俄国的支持下想要实现'大塞尔维亚'，这直接威胁到了哪个帝国的生存？", options: ["A. 俄罗斯帝国", "B. 奥匈帝国", "C. 奥斯曼帝国", "D. 德意志帝国"], answer: "B", knowledgePoint: "大塞尔维亚", analysis: "'大塞尔维亚'的设想是把所有南部斯拉夫人联合起来，这将分裂奥匈帝国境内的斯拉夫地区，危及奥匈帝国的统一。" },
  ...
  { lesson: 27, title: "军备竞赛", questions: [
    ...
    { type: "choice", difficulty: 1, text: "'安全困境'指的是什么？", options: ["A. 各国和平共处相互信任", "B. 一国的扩军使邻国不安，邻国也扩军——结果所有人都不安全", "C. 各国都放弃武器所以更安全", "D. 只有在军队强大时才有安全感"], answer: "B", knowledgePoint: "安全困境", analysis: "你为了安全而扩军——你的扩军让邻国感到不安全——邻国也扩军——结果是所有人花更多的钱却更不安全。" },
    ...
    { type: "choice", difficulty: 2, text: "1898年开始的英德海军竞赛中，英国的回应策略是什么？", options: ["A. 承认德国的海上霸权", "B. 建造更先进的'无畏舰'", "C. 大规模扩充陆军", "D. 与德国结盟"], answer: "B", knowledgePoint: "无畏舰竞赛", analysis: "德国挑战英国的海上霸权——英国的回应是造无畏舰，一种让所有现役战舰过时的新型战列舰。德国不甘示弱也开始造无畏舰。" },
  ...
  { lesson: 28, title: "一战起因", questions: [
    ...
    { type: "choice", difficulty: 1, text: "一战的导火索是萨拉热窝刺杀事件，但'导火索'不等于'原因'。一战的根本原因是：", options: ["A. 刺杀者的个人仇恨", "B. 民族主义、军备竞赛和同盟体系的深层矛盾", "C. 斐迪南大公不受欢迎", "D. 德国人策划了刺杀"], answer: "B", knowledgePoint: "导火索vs原因", analysis: "萨拉热窝的枪声点燃了火药桶——但火药桶不是枪声制造的，是长期积累的帝国主义竞争、民族主义、军备竞赛和同盟体系制造的。" },
    ...
    { type: "choice", difficulty: 2, text: "从萨拉热窝刺杀到世界大战爆发用了多长时间？", options: ["A. 三天", "B. 六个星期", "C. 六个月", "D. 一年"], answer: "B", knowledgePoint: "七月危机", analysis: "6月28日刺杀→7月28日奥匈向塞尔维亚宣战→8月4日英国向德国宣战——六个星期从一起刺杀到世界大战。" },
  ...
  { lesson: 29, title: "战壕战", questions: [
    ...
    { type: "choice", difficulty: 1, text: "一战西线战场的长度约为：", options: ["A. 100公里", "B. 700公里", "C. 2000公里", "D. 5000公里"], answer: "B", knowledgePoint: "西线长度", analysis: "从瑞士边境到英吉利海峡，西线的堑壕系统长达约七百公里——双方在这里对峙了四年。" },
    ...
    { type: "choice", difficulty: 2, text: "索姆河战役第一天英军的伤亡人数是：", options: ["A. 约1000人", "B. 约1万人", "C. 约5.7万人", "D. 约57万人"], answer: "C", knowledgePoint: "索姆河伤亡", analysis: "1916年7月1日——索姆河战役第一天——英军伤亡57,470人，其中19,240人死亡——这是英国军事史上最惨重的一天。" },
  ...
  { lesson: 30, title: "凡尔赛条约", questions: [
    ...
    { type: "choice", difficulty: 1, text: "凡尔赛条约第231条（战争罪责条款）的内容是什么？", options: ["A. 德国割让所有殖民地", "B. 德国承担全部战争责任", "C. 德国支付具体赔款数额", "D. 德国解散全部军队"], answer: "B", knowledgePoint: "第231条", analysis: "第231条宣布德国对战争造成的所有损失承担全部责任——这在德国人看来是不公平的道德审判。" },
    ...
    { type: "choice", difficulty: 2, text: "英国经济学家凯恩斯在凡尔赛条约签署后预言了什么？", options: ["A. 德国会迅速复兴", "B. 这不是和平——是二十年的停战", "C. 欧洲会永久和平", "D. 美国会接管欧洲"], answer: "B", knowledgePoint: "凯恩斯的预言", analysis: "凯恩斯是英国参加和会的代表——他提前退出了会议并写了一本书，预言凡尔赛条约不会带来和平，只会导致另一场战争。1939年——他的预言应验了。" },
  ...
  { lesson: 31, title: "索姆河战役", questions: [
    ...
    { type: "choice", difficulty: 1, text: "索姆河战役中英军第一天的伤亡是多少？", options: ["A. 约1千人", "B. 约1万人", "C. 约5.7万人", "D. 约57万人"], answer: "C", knowledgePoint: "索姆河伤亡", analysis: "第一天英军就伤亡57,470人——其中近两万人阵亡——这是英国军事史上最惨重的一天。" },
    ...
    { type: "choice", difficulty: 2, text: "索姆河战役五个月后战线移动了多少？", options: ["A. 约1公里", "B. 约10公里", "C. 约100公里", "D. 约500公里"], answer: "B", knowledgePoint: "战线移动", analysis: "双方超过一百万人伤亡——战线移动了约十公里——每前进一米就死两名士兵。" },
  ...
  { lesson: 32, title: "十月革命", questions: [
    ...
    { type: "choice", difficulty: 1, text: "列宁提出的三个口号是：", options: ["A. 自由、平等、博爱", "B. 和平、土地、面包", "C. 战争、荣誉、祖国", "D. 统一、发展、强大"], answer: "B", knowledgePoint: "列宁的口号", analysis: "列宁提出的和平、土地、面包三个口号直接回应了当时俄国人民最迫切的痛苦，比临时政府的承诺更有吸引力。" },
    ...
    { type: "choice", difficulty: 2, text: "二月革命后临时政府犯下的致命错误是什么？", options: ["A. 没有废除封建制度", "B. 决定继续参加一战", "C. 允许列宁回国", "D. 解散了议会"], answer: "B", knowledgePoint: "临时政府的失误", analysis: "临时政府选择继续参战——希望通过打赢战争来赢得支持。但战争不会因为你希望赢就赢——前线继续溃败，民众更加绝望。" },
  ...
  { lesson: 33, title: "纳粹德国崛起", questions: [
    ...
    { type: "choice", difficulty: 1, text: "魏玛共和国崩溃的重要经济背景是？", options: ["A. 经济空前繁荣", "B. 大萧条导致失业率超30%", "C. 对外贸易顺差大", "D. 海外殖民地收入丰厚"], answer: "B", knowledgePoint: "大萧条", analysis: "大萧条使德国经济崩溃——工业停产、银行倒闭、超过600万人失业——绝望中的人投票给了极端政党。" },
    ...
    { type: "choice", difficulty: 2, text: "国会纵火案后希特勒通过哪个法案将立法权转移到自己手中？", options: ["A. 魏玛宪法", "B. 授权法案", "C. 纽伦堡法案", "D. 凡尔赛条约"], answer: "B", knowledgePoint: "授权法案", analysis: "1933年国会纵火案后，希特勒利用事件制造的恐慌气氛，让国会通过了《授权法案》——把立法权从国会转移到了内阁，即希特勒手中。" },
  ...
  { lesson: 34, title: "第二次世界大战", questions: [
    ...
    { type: "choice", difficulty: 1, text: "闪击战战术的核心是什么？", options: ["A. 用骑兵突袭敌人后方", "B. 坦克、飞机和步兵的高速协同作战", "C. 使用毒气弹大规模杀伤", "D. 通过宣传瓦解敌军士气"], answer: "B", knowledgePoint: "闪击战", analysis: "闪击战的核心是坦克集群在空军掩护下高速突破敌军防线——不是靠人数而是靠速度和协同。" },
    ...
    { type: "choice", difficulty: 2, text: "法国在马奇诺防线上投入巨资，结果德军从哪里绕过？", options: ["A. 从海上登陆", "B. 穿过阿登森林", "C. 从意大利进攻", "D. 从西班牙借道"], answer: "B", knowledgePoint: "马奇诺防线", analysis: "法国在德法边境修建了坚固的马奇诺防线——德军却穿过被认为'坦克无法通过'的阿登森林绕过了它。" },
  ...
  { lesson: 35, title: "大屠杀", questions: [
    ...
    { type: "choice", difficulty: 1, text: "大屠杀的'最终解决方案'是在哪次会议上制定的？", options: ["A. 雅尔塔会议", "B. 万湖会议", "C. 慕尼黑会议", "D. 柏林会议"], answer: "B", knowledgePoint: "万湖会议", analysis: "1942年1月，纳粹高级官员在柏林万湖开会，制定了系统性地消灭欧洲约一千一百万犹太人的'最终解决方案'。" },
    ...
    { type: "choice", difficulty: 2, text: "战后对纳粹领导人进行审判的地点是在：", options: ["A. 柏林", "B. 纽伦堡", "C. 慕尼黑", "D. 维也纳"], answer: "B", knowledgePoint: "纽伦堡审判", analysis: "1945-1946年，同盟国在德国纽伦堡对纳粹主要战犯进行了审判，确立了'反人类罪'的法律概念。" },
  ...
  { lesson: 36, title: "雅尔塔会议", questions: [
    ...
    { type: "choice", difficulty: 1, text: "雅尔塔会议的三个参加国是：", options: ["A. 美、英、法", "B. 美、英、苏", "C. 美、苏、中", "D. 英、苏、中"], answer: "B", knowledgePoint: "三巨头", analysis: "雅尔塔会议由美国总统罗斯福、英国首相丘吉尔和苏联领导人斯大林参加。" },
    ...
    { type: "choice", difficulty: 2, text: "雅尔塔会议上关于德国的决定是什么？", options: ["A. 德国被彻底毁灭", "B. 德国被四个战胜国分区占领", "C. 德国继续保持统一", "D. 德国成为中立国"], answer: "B", knowledgePoint: "德国分区占领", analysis: "德国被分成四个占领区——美国、英国、法国、苏联各管一块。柏林虽然深入苏联占领区也被分成四块。" },
  ...
  { lesson: 37, title: "铁幕与马歇尔计划", questions: [
    ...
    { type: "choice", difficulty: 1, text: "'铁幕'指的是什么？", options: ["A. 欧洲的钢铁工业区", "B. 苏联在东欧建立的势力和控制线", "C. 防止德国入侵的军事防线", "D. 联合国在欧洲的巡逻线"], answer: "B", knowledgePoint: "铁幕的含义", analysis: "铁幕是一个比喻——苏联在东欧建立了一条封锁线，铁幕东侧的国家不能自由选择政府、不能自由与西方贸易、不能自由获取信息。" },
    ...
    { type: "choice", difficulty: 2, text: "杜鲁门主义的核心是：", options: ["A. 孤立主义", "B. 遏制政策", "C. 扩张主义", "D. 和平主义"], answer: "B", knowledgePoint: "杜鲁门主义", analysis: "杜鲁门主义确立了美国的遏制政策，旨在阻止苏联的扩张。" },
    { type: "choice", difficulty: 3, text: "马歇尔计划援助欧洲的金额约为：", options: ["A. 13亿美元", "B. 130亿美元", "C. 1300亿美元", "D. 1.3万亿美元"], answer: "B", knowledgePoint: "马歇尔计划金额", analysis: "1948年到1951年间美国通过马歇尔计划向16个西欧国家提供了约130亿美元的援助——不是贷款，主要是赠款和物资。" },
  ...
  { lesson: 38, title: "朝鲜战争", questions: [
    ...
    { type: "choice", difficulty: 1, text: "朝鲜战争前朝鲜半岛的分界线是？", options: ["A. 17度线", "B. 38度线（三八线）", "C. 纬线39度", "D. 北纬40度"], answer: "B", knowledgePoint: "三八线", analysis: "二战后朝鲜以三八线（北纬38度）为界，苏联占领北部、美国占领南部——后来分别建立了两个意识形态完全不同的国家。" },
    ...
    { type: "choice", difficulty: 2, text: "朝鲜战争中中国在什么时候参战？", options: ["A. 战争刚开始", "B. 联合国军打到鸭绿江边时", "C. 战争结束时", "D. 中国没有参战"], answer: "B", knowledgePoint: "中国参战", analysis: "1950年10月，联合国军一路向北打到鸭绿江边后，中国派遣志愿军参战，将联军推回三八线附近。" },
  ...
  { lesson: 39, title: "古巴导弹危机", questions: [
    ...
    { type: "choice", difficulty: 1, text: "古巴导弹危机持续了多少天？", options: ["A. 3天", "B. 13天", "C. 30天", "D. 100天"], answer: "B", knowledgePoint: "十三天", analysis: "从1962年10月16日肯尼迪得知导弹部署，到10月28日赫鲁晓夫同意撤出——整整十三天。" },
    ...
    { type: "choice", difficulty: 2, text: "古巴导弹危机中最接近战争的是哪一天？", options: ["A. 危机第一天", "B. 10月27日'黑色星期六'", "C. 最后一天", "D. 危机一周后"], answer: "B", knowledgePoint: "黑色星期六", analysis: "10月27日——美军U-2侦察机在古巴被击落——军方要求立即报复——肯尼迪拒绝——这是人类离核战争最近的时刻。" },
  ...
  { lesson: 40, title: "柏林墙", questions: [
    ...
    { type: "choice", difficulty: 1, text: "修建柏林墙的直接原因是什么？", options: ["A. 防御北约进攻", "B. 阻止东德人大规模逃往西德", "C. 作为旅游景点", "D. 美化城市环境"], answer: "B", knowledgePoint: "建墙原因", analysis: "1949到1961年间约270万东德人通过西柏林逃往西德——大部分是年轻人和技术工人——东德经济无法承受这种流失。" },
    ...
    { type: "choice", difficulty: 2, text: "柏林墙倒塌的直接触发事件是什么？", options: ["A. 苏联下令拆除", "B. 东德政府发言人的口误导致民众涌向边境", "C. 西德军队进攻东德", "D. 联合国决议"], answer: "B", knowledgePoint: "倒塌的触发事件", analysis: "1989年11月9日，东德政府发言人沙博夫斯基在新闻发布会上对新旅行法规表述不清——成千上万人以为边境立即开放——涌向检查站——守卫在压力下打开了大门。" },
  ...
  { lesson: 41, title: "印度独立", questions: [
    ...
    { type: "choice", difficulty: 1, text: "甘地最著名的非暴力抗议行动是？", options: ["A. 武装起义占领总督府", "B. 食盐进军——步行400公里自己制盐", "C. 绝食至死威胁英国", "D. 联合日本对抗英国"], answer: "B", knowledgePoint: "食盐进军", analysis: "1930年，甘地步行400公里到海边自己制盐——这个简单到每个人都能参与、勇敢到英国人无法忽视的行动点燃了全印度的反抗。" },
    ...
    { type: "choice", difficulty: 2, text: "甘地没有参加1947年8月15日的独立庆祝仪式，原因是：", options: ["A. 他生病了", "B. 他在绝食抗议分治带来的教派暴力", "C. 他被英国禁止参加", "D. 他不认为自己对国家有贡献"], answer: "B", knowledgePoint: "甘地的绝食", analysis: "甘地在加尔各答绝食——为分治后大规模教派暴力中的死难者祈祷，也为印度教徒和穆斯林之间的和解。" },
  ...
  { lesson: 42, title: "非洲独立浪潮", questions: [
    ...
    { type: "choice", difficulty: 1, text: "撒哈拉以南非洲第一个独立的国家是：", options: ["A. 尼日利亚", "B. 加纳", "C. 肯尼亚", "D. 南非"], answer: "B", knowledgePoint: "加纳独立", analysis: "1957年，加纳在恩克鲁玛的领导下独立——这是撒哈拉以南非洲第一个摆脱殖民统治的国家，点燃了全非洲的希望。" },
    ...
    { type: "choice", difficulty: 2, text: "殖民主义给独立后的非洲留下最持久的政治问题是什么？", options: ["A. 没有国歌和国旗", "B. 柏林会议上用尺子画的直线边界", "C. 没有人想当总统", "D. 没有货币"], answer: "B", knowledgePoint: "殖民边界问题", analysis: "殖民者走了但边界留了下来——这些直线把同一民族分到不同国家，把世仇关进同一国家，成为非洲无数次冲突的根源。" },
  ...
  { lesson: 43, title: "巴以冲突", questions: [
    ...
    { type: "choice", difficulty: 1, text: "巴以冲突的核心是什么？", options: ["A. 纯粹的宗教教义分歧", "B. 两个民族对同一片土地的主权争夺", "C. 水资源分配不均", "D. 冷战超级大国的操控"], answer: "B", knowledgePoint: "冲突核心", analysis: "犹太人和阿拉伯人对巴勒斯坦地区都有历史主张——两个真实的历史叙事指向同一片土地，这是冲突最核心的问题。" },
    ...
    { type: "choice", difficulty: 2, text: "1967年六日战争中以色列占领的区域不包括：", options: ["A. 西奈半岛", "B. 约旦河西岸", "C. 埃及全境", "D. 加沙地带"], answer: "C", knowledgePoint: "六日战争占领区", analysis: "六日战争中以色列占领了西奈半岛、加沙地带、约旦河西岸和东耶路撒冷——但从未占领埃及全境。" },
  ...
  { lesson: 44, title: "越南战争", questions: [
    ...
    { type: "choice", difficulty: 1, text: "美国在越南投入地面部队最多时约有：", options: ["A. 5万人", "B. 54万人", "C. 100万人", "D. 200万人"], answer: "B", knowledgePoint: "美军数量", analysis: "1968年高峰期约有54万美军在越南——世界上最强大的军队陷入了一场无法打赢的丛林战争。" },
    ...
    { type: "choice", difficulty: 2, text: "1968年春节攻势的意义在于：", options: ["A. 越共被彻底消灭", "B. 虽然越共军事上输了但政治赢了——美国民众不再相信政府在赢", "C. 战争结束", "D. 美国增兵越南"], answer: "B", knowledgePoint: "春节攻势", analysis: "春节攻势中越共攻入了美国大使馆——虽然被击退——但电视画面让美国民众看到了战争的真实面貌，反战运动从此急剧升级。" },
  ...
  { lesson: 45, title: "民权运动", questions: [
    ...
    { type: "choice", difficulty: 1, text: "1955年蒙哥马利公车抵制的导火索是：", options: ["A. 公车票价上涨", "B. 罗莎·帕克斯拒绝给白人让座", "C. 公车路线被取消", "D. 黑人被禁止乘坐公车"], answer: "B", knowledgePoint: "罗莎·帕克斯", analysis: "1955年12月1日，黑人女裁缝罗莎·帕克斯在公车上拒绝把座位让给白人——这一事件点燃了长达381天的蒙哥马利公车抵制运动。" },
    ...
    { type: "choice", difficulty: 2, text: "1964年民权法案的主要作用是？", options: ["A. 建立了种族隔离制度", "B. 禁止基于种族、肤色的歧视", "C. 取消了黑人投票权", "D. 允许黑人担任总统"], answer: "B", knowledgePoint: "民权法案", analysis: "1964年民权法案禁止在公共设施、就业和教育中的种族歧视——这是民权运动最重要的法律成果，但法律改变不意味着社会现实立刻改变。" },
  ...
  { lesson: 46, title: "史料分析", questions: [
    ...
    { type: "choice", difficulty: 1, text: "以下哪项属于一手资料？", options: ["A. 2023年出版的历史教科书", "B. 1918年士兵在前线写的家信", "C. 历史教授的讲课稿", "D. 维基百科词条"], answer: "B", knowledgePoint: "一手资料举例", analysis: "1918年的家信是当时写的原始材料——直接来自历史现场，没有经过后人的加工和解释。" },
    ...
    { type: "choice", difficulty: 2, text: "判断一份史料是否可靠，应该先问什么问题？", options: ["A. 它有多古老", "B. 谁写的、写给谁、为什么写", "C. 它有多长", "D. 它是否被很多人引用"], answer: "B", knowledgePoint: "史料批判", analysis: "判断史料可靠性要分析来源（谁写的）、背景（在什么情况下写的）、目的（为什么写）——这些决定了史料的价值和局限。" },
  ...
  { lesson: 47, title: "偏见与视角", questions: [
    ...
    { type: "choice", difficulty: 1, text: "历史叙述中的偏见主要来自哪里？", options: ["A. 历史学家不诚实", "B. 作者的立场、时代背景和视角", "C. 史料本身有错", "D. 读者理解能力差"], answer: "B", knowledgePoint: "偏见的来源", analysis: "偏见不一定来自恶意——一个1830年的英国历史学家真诚地认为帝国是好事，这是他的时代和立场塑造的视角。" },
    ...
    { type: "choice", difficulty: 2, text: "多元视角的历史研究方法论意义是什么？", options: ["A. 让历史研究变得更混乱", "B. 通过不同视角的交叉让历史理解更完整", "C. 证明没有历史真相", "D. 取消历史研究的价值"], answer: "B", knowledgePoint: "多元视角的意义", analysis: "多元视角不是否定历史真相，而是承认真相比一种叙述更复杂——同一事件从不同视角看有不同的面向。" },
  ...
  { lesson: 48, title: "历史解释", questions: [
    ...
    { type: "choice", difficulty: 1, text: "历史解释多元性的主要原因是什么？", options: ["A. 史料太少", "B. 不同的理论框架和问题意识", "C. 历史学家不专业", "D. 历史本身不存在"], answer: "B", knowledgePoint: "多元性原因", analysis: "不同历史学家带着不同的问题和理论框架研究同一事件——马克思主义者看到阶级冲突，文化史学家看到思想的影响，政治史学家看到决策——他们都提供了不同的解释面。" },
    ...
    { type: "choice", difficulty: 2, text: "好的历史因果分析应该包含哪些层次？", options: ["A. 只需要找出直接原因", "B. 同时考虑长期/短期、结构/个人、直接/根本多个层面", "C. 只看谁的错", "D. 只需列出所有事件"], answer: "B", knowledgePoint: "因果分析的层次", analysis: "好的历史分析不是满足于单一原因，而是梳理多个层面：长期结构性原因、短期触发因素、个人决策的作用等，评估它们的相对重要性。" },
  ...
  { lesson: 49, title: "口述历史", questions: [
    ...
    { type: "choice", difficulty: 1, text: "口述历史最重要的伦理原则是什么？", options: ["A. 获取尽可能多的信息", "B. 不伤害受访者，尊重其知情同意权", "C. 尽可能长时间采访", "D. 公布采访全部内容"], answer: "B", knowledgePoint: "口述历史伦理", analysis: "受访者有权知道研究目的、有权拒绝回答任何问题、有权撤回或修改陈述——不能为了'更好的故事'而伤害活着的人。" },
    ...
    { type: "choice", difficulty: 2, text: "做口述历史采访时最有效的提问方式是：", options: ["A. 问是非题——'你是不是害怕了？'", "B. 问开放题——'告诉我那天你经历了什么'", "C. 让受访者自己说不干预", "D. 引导受访者说出你想要的答案"], answer: "B", knowledgePoint: "采访技巧", analysis: "开放性问题让叙述者主导节奏——'告诉我……'比'是不是……'能得到更丰富、更自然的故事。" },
  ...
  { lesson: 50, title: "GCSE综合复习", questions: [
    ...
    { type: "choice", difficulty: 1, text: "复习GCSE历史最有效的方法是：", options: ["A. 死记硬背孤立的事件和年代", "B. 理解事件之间的因果链条和相互关联", "C. 只背诵教科书最后一章", "D. 只做选择题练习"], answer: "B", knowledgePoint: "复习策略", analysis: "理解了诺曼征服→封建制度→大宪章→议会这样的因果链，就不需要死记硬背也能推导出事件顺序。" },
    ...
    { type: "choice", difficulty: 2, text: "材料分析题主要考查学生的什么能力？", options: ["A. 记忆力", "B. 分析史料来源、偏见和可靠性的能力", "C. 写字速度", "D. 猜测出题意图的能力"], answer: "B", knowledgePoint: "材料分析题", analysis: "材料分析题给你一份陌生史料——你要分析它的来源、它的偏见、它告诉了你什么——这比背诵需要更强的批判性思维能力。" },
  ...
  { lesson: 51, title: "政治史深度研究", questions: [
    ...
    { type: "choice", difficulty: 1, text: "政治史研究的三个核心问题是：", options: ["A. 何时、何地、何人", "B. 权力归属、如何获取、决策影响", "C. 战争、和平、条约", "D. 国王、议会、教会"], answer: "B", knowledgePoint: "政治史问题", analysis: "政治史研究谁拥有权力、如何获得、做了什么决策、产生了什么后果——而非简单的年表和人名。" },
    ...
    { type: "choice", difficulty: 2, text: "分析政治人物时，不应问的问题是什么？", options: ["A. 他推行了什么政策", "B. 他是好人还是坏人", "C. 这些政策对谁有利", "D. 他的决策背景是什么"], answer: "B", knowledgePoint: "政治人物分析", analysis: "历史分析不是道德评判——'好人或坏人'不是历史问题。应该问：他的政策是什么、对谁产生了什么影响、在什么条件下做出的决策。" },
  ...
  { lesson: 52, title: "外交史", questions: [
    ...
    { type: "choice", difficulty: 1, text: "研究外交史最核心的一手资料是什么？", options: ["A. 教科书", "B. 外交档案和内部电报", "C. 报纸报道", "D. 政治家传记"], answer: "B", knowledgePoint: "外交史资料", analysis: "外交档案和内部电报记录了真实的决策过程——公开声明是包装过的，内部文件才更接近政治家的真实想法。" },
    ...
    { type: "choice", difficulty: 2, text: "凡尔赛条约第231条（战争罪责条款）在外交史研究中的意义是什么？", options: ["A. 它精确地分配了战争责任", "B. 它制造了持续的不公平感，成为二战的伏笔", "C. 它只是一个形式条款没有实际影响", "D. 它让德国接受了和平"], answer: "B", knowledgePoint: "战罪条款的影响", analysis: "第231条宣布德国承担全部战争责任——德国人认为这不公平，这种怨恨被希特勒完美地利用来动员民族主义情绪。" },
  ...
  { lesson: 53, title: "档案研究", questions: [
    ...
    { type: "choice", difficulty: 1, text: "读档案时第一个要问的问题是：", options: ["A. 它说了什么", "B. 谁写的、写给谁、为什么写", "C. 它有多少页", "D. 它的字迹是否清晰"], answer: "B", knowledgePoint: "档案阅读方法", analysis: "作者的身份决定了他会说什么和不说什么，写作对象决定了他用什么语气，写作背景决定了他的记忆是否可靠。" },
    ...
    { type: "choice", difficulty: 2, text: "为什么私人信件作为档案具有独特的价值？", options: ["A. 它比官方文件更准确", "B. 它比官方文件更坦率——写作者不需要公开表演", "C. 它总是最长的", "D. 它更容易获取"], answer: "B", knowledgePoint: "私人信件价值", analysis: "在私人信件中，写作者不需要像在公开声明中那样表演——他们更可能表达真实想法和担忧，这对历史学家极为珍贵。" },
  ...
  { lesson: 54, title: "历史争论解析", questions: [
    ...
    { type: "choice", difficulty: 1, text: "历史学家之间的争论对历史研究的意义是：", options: ["A. 有害的，破坏了学术团结", "B. 有益的，推动了知识进步", "C. 中性的，没有什么影响", "D. 可悲的，证明历史不是科学"], answer: "B", knowledgePoint: "争论的价值", analysis: "当一个论点被质疑，作者必须回应：要么找到更多证据支持自己，要么修正自己的立场——不管哪个结果，我们对历史的理解都深化了。" },
    ...
    { type: "choice", difficulty: 2, text: "历史争论最常来自以下哪个方面？", options: ["A. 史料是否被人伪造", "B. 面对同样的史料，不同的解释框架和理论立场", "C. 历史学家的个人关系", "D. 历史事件的年月顺序"], answer: "B", knowledgePoint: "争论的根源", analysis: "同样的史料可以用不同理论解读——马克思主义者看到阶级冲突，修正主义者看到政治博弈——框架不同，结论不同。" },
  ...
  { lesson: 55, title: "一战起因学术争议", questions: [
    ...
    { type: "choice", difficulty: 1, text: "费希尔在一战责任问题上的立场是什么？", options: ["A. 所有国家都有责任", "B. 德国精英蓄意发动了战争", "C. 没有责任方", "D. 法国和俄国负全责"], answer: "B", knowledgePoint: "费希尔立场", analysis: "费希尔在1961年出版的《德国争雄世界》中提出：一战不是意外发生的——德国的精英阶层蓄意发动了扩张性战争。" },
    ...
    { type: "choice", difficulty: 2, text: "费希尔论战在德国史学界引发争议的原因是什么？", options: ["A. 费希尔的观点太温和", "B. 它触及了一战责任的敏感话题，挑战了德国史学界的既有立场", "C. 费希尔的德语太差无法阅读", "D. 争论双方都不尊重史料"], answer: "B", knowledgePoint: "论战的敏感性", analysis: "费希尔认为德国蓄意发动战争——这挑战了德国史学界'各国有责'的共识，触动了德国人'凡尔赛条约是不公正的'的敏感神经。" },
  ...
  { lesson: 56, title: "媒体与宣传", questions: [
    ...
    { type: "choice", difficulty: 1, text: "一战中宣传最常用的情感动员手法是什么？", options: ["A. 理性的数据分析", "B. 激发爱国热情和制造羞耻感", "C. 科学论证", "D. 全面客观报道"], answer: "B", knowledgePoint: "宣传手法", analysis: "一战海报的核心技巧是情感动员——激发爱国情感、制造'别人都去了你为什么不去'的羞耻感、把参战塑造成英雄主义行为。" },
    ...
    { type: "choice", difficulty: 2, text: "纳粹宣传部长戈培尔的名言'重复一个谎言千次，它就成了真理'说明了宣传的什么机制？", options: ["A. 理性说服", "B. 通过不断重复让特定信息变成'常识'", "C. 用科学数据说话", "D. 尊重多元观点"], answer: "B", knowledgePoint: "戈培尔的法则", analysis: "纳粹宣传的核心是重复——不断重复同样的信息直到人们不再质疑它，把它当作'理所当然'的常识。" },
    ...
    { type: "open", text: "今天你身边的'宣传'和一百年前的宣传有什么不同？社交媒体上的信息推送是'宣传'吗？请结合你对宣传的理解，分析现代信息环境中识别宣传技能的重要性。", scoringPoints: ["能识别现代信息环境中宣传的变体（算法推送、信息茧房）", "能比较传统宣传和现代信息操控的异同", "能提出识别宣传和维护独立思考的方法"], maxScore: 6 }
  ]},
  ...
  { lesson: 57, title: "女性史", questions: [
    ...
    { type: "choice", difficulty: 1, text: "英国女性在什么年份获得了和男性同等的投票权？", options: ["A. 1918年", "B. 1928年", "C. 1938年", "D. 1948年"], answer: "B", knowledgePoint: "女性普选权", analysis: "1918年30岁以上女性获得投票权——1928年年龄降到21岁，与男性完全平等。" },
    ...
    { type: "choice", difficulty: 2, text: "一战如何改变了女性的社会角色？", options: ["A. 女性完全回归家庭", "B. 女性大规模进入劳动市场代替参军的男性", "C. 没有产生任何变化", "D. 女性被禁止工作"], answer: "B", knowledgePoint: "女性与一战", analysis: "一战期间数百万男性上了战场，女性走进工厂、公交、医院——一战前英国约357万女性受雇，战后接近800万——翻了不止一倍。" },
  ...
  { lesson: 58, title: "科技与战争", questions: [
    ...
    { type: "choice", difficulty: 1, text: "坦克第一次大规模用于战场是在哪场战役？", options: ["A. 凡尔登战役", "B. 索姆河战役", "C. 马恩河战役", "D. 中途岛海战"], answer: "B", knowledgePoint: "坦克首次使用", analysis: "1916年9月15日——英军在索姆河战役中投入了第一批坦克——虽然数量少、故障多——但预示了未来战争的形式。" },
    ...
    { type: "choice", difficulty: 2, text: "二战中德国闪击战成功的技术基础是什么？", options: ["A. 大规模使用骑兵", "B. 坦克集群加飞机协同作战加无线电通信", "C. 使用核武器", "D. 挖地道偷袭"], answer: "B", knowledgePoint: "闪击战的技术基础", analysis: "闪击战的核心不是坦克本身——是坦克、斯图卡俯冲轰炸机和无线电通信被组织成一个整体，实现了高速协同作战。" },
  ...
  { lesson: 59, title: "比较革命研究", questions: [
    ...
    { type: "choice", difficulty: 1, text: "法国大革命最突出的特征是：", options: ["A. 温和渐进的改革", "B. 激进的社会政治变革", "C. 没有暴力", "D. 迅速恢复旧制度"], answer: "B", knowledgePoint: "法国大革命特征", analysis: "法国大革命五年内从君主制走到共和国、走到恐怖统治、走向拿破仑——速度极快、范围极广、暴力性极强。" },
    ...
    { type: "choice", difficulty: 2, text: "比较法国大革命和俄国革命，两者共同的激进原因是？", options: ["A. 两个国家都很富有", "B. 旧制度彻底腐朽，加上内外战争的压力", "C. 两国的宗教冲突", "D. 两国的国王是兄弟"], answer: "B", knowledgePoint: "革命的激进", analysis: "两次革命的共同点是：旧制度的彻底腐朽让中间路线不再可能，内外战争的压力把革命推向了极端——激进不是必然，但在这些条件下极难避免。" },
  ...
  { lesson: 60, title: "历史哲学", questions: [
    ...
    { type: "choice", difficulty: 1, text: "历史决定论的核心观点是什么？", options: ["A. 历史是完全随机的", "B. 历史的发展遵循一定的规律和逻辑", "C. 历史由个人意志决定", "D. 历史无法被认识"], answer: "B", knowledgePoint: "历史决定论", analysis: "历史决定论认为历史不是偶然的积累，而是有方向、有规律的进程——比如马克思认为历史是生产力和生产关系矛盾运动驱动的。" },
    ...
    { type: "choice", difficulty: 2, text: "历史决定论最有力的批评是：", options: ["A. 它让历史研究变简单了", "B. 如果一切都是'规律'决定的，个人选择还有意义吗？", "C. 它太复杂了", "D. 它只适用于欧洲历史"], answer: "B", knowledgePoint: "决定论的批评", analysis: "如果一切都是历史规律决定的——那希特勒的决策有意义吗？那些试图避免战争的外交官的努力是徒劳吗？决定论面临的核心问题是：它如何解释个体能动性在历史中的作用？" },
  ...
  { lesson: 61, title: "马克思主义史学", questions: [
    ...
    { type: "choice", difficulty: 1, text: "马克思的历史唯物主义认为历史的根本动力是：", options: ["A. 伟大领袖的意志", "B. 生产力和生产关系的矛盾", "C. 宗教改革", "D. 自然环境的改变"], answer: "B", knowledgePoint: "历史动力", analysis: "马克思认为历史不是伟人推动的——而是生产力和生产关系的矛盾运动驱动的。生产方式的变化决定了社会结构的变化。" },
    ...
    { type: "choice", difficulty: 2, text: "马克思主义史学的'阶级分析'方法最适用于分析什么类型的历史问题？", options: ["A. 外交条约的签订过程", "B. 工业革命中的劳资冲突和工人运动", "C. 国王的个人性格", "D. 艺术风格的演变"], answer: "B", knowledgePoint: "阶级分析的应用", analysis: "阶级分析在分析经济变革引发的社会冲突方面最有力——如工业革命中资产阶级与工人阶级的矛盾、工人运动的兴起等。" },
  ...
  { lesson: 62, title: "后现代史学", questions: [
    ...
    { type: "choice", difficulty: 1, text: "后现代史学对历史叙述的核心质疑是什么？", options: ["A. 历史学家都在撒谎", "B. 历史叙述不可避免地包含选择和建构——不是还原而是创造故事", "C. 历史研究没有意义", "D. 所有历史书都应该被烧掉"], answer: "B", knowledgePoint: "后现代的核心质疑", analysis: "后现代不是否定历史是真实的——而是说历史学家在选择研究什么、如何叙述时，这些选择本身就带有立场和价值观。" },
    ...
    { type: "choice", difficulty: 2, text: "后现代史学最受批评的方面是什么？", options: ["A. 它太保守了", "B. 如果完全接受后现代视角，可能会滑向'一切皆相对'的虚无主义", "C. 它太容易被理解", "D. 它太尊重史料了"], answer: "B", knowledgePoint: "后现代的局限", analysis: "如果后现代主义滑向'一切皆相对，没有真假之分'——那纳粹宣传和严肃学术研究有什么本质区别？这是后现代史学面临的最大挑战。" },
  ...
  { lesson: 63, title: "性别史与后殖民史学", questions: [
    ...
    { type: "choice", difficulty: 1, text: "后殖民理论批判的核心对象是：", options: ["A. 殖民地人民的落后文化", "B. 以欧洲为中心的殖民主义叙事及其权力关系", "C. 独立运动的激进手段", "D. 殖民地经济的发展模式"], answer: "B", knowledgePoint: "后殖民核心", analysis: "后殖民理论批判的是把殖民描述成'文明化使命'的叙事框架——它揭示谁有资格定义'文明'、谁的历史被书写、谁的声音被遗漏。" },
    ...
    { type: "choice", difficulty: 2, text: "边缘群体历史的研究对主流历史叙事有什么影响？", options: ["A. 没有影响", "B. 挑战主流叙事的完整性，让历史变得更丰富", "C. 破坏历史学的客观性", "D. 只适用于少数群体的自我关注"], answer: "B", knowledgePoint: "边缘群体历史的意义", analysis: "边缘群体的历史不是要取代主流叙事——而是要扩充它。加入女性的、劳工的、被殖民者的视角后，历史图像变得更丰富、更诚实。" },
  ...
  { lesson: 64, title: "计量史学", questions: [
    ...
    { type: "choice", difficulty: 1, text: "计量史学最突出的优势是什么？", options: ["A. 能讲述生动的故事", "B. 能提供精确可验证的数据支撑", "C. 能取代所有其他历史研究方法", "D. 不需要阅读大量史料"], answer: "B", knowledgePoint: "计量史学的优势", analysis: "计量史学能把'工人工资下降'这个模糊印象变成'1800-1850年实际工资下降约15%'——精确、可验证、可被质疑。" },
    ...
    { type: "choice", difficulty: 2, text: "计量史学最大的局限是：", options: ["A. 数据太少", "B. 无法量化情感、意义和文化经验等历史中最重要的内容", "C. 计算太复杂", "D. 历史学家不懂数学"], answer: "B", knowledgePoint: "计量史学的局限", analysis: "数字能告诉你1840年代爱尔兰有多少人死于饥荒——但数字告诉不了你一个母亲看着孩子饿死时的心情——这需要日记和文学来传达。" },
  ...
  { lesson: 65, title: "公共史学", questions: [
    ...
    { type: "choice", difficulty: 1, text: "历史记忆塑造集体认同——'我们是谁'。以下哪个例子最能体现历史记忆的建构作用？", options: ["A. 一个家族的家谱", "B. 英国每年11月11日的停战纪念日全国默哀", "C. 个人日记", "D. 护照照片"], answer: "B", knowledgePoint: "历史记忆的建构", analysis: "停战纪念日通过集体默哀这个仪式，每年重申一次'我们是谁：一个经历了巨大牺牲、珍视和平的国家'——这是集体记忆的建构。" },
    ...
    { type: "choice", difficulty: 2, text: "纪念与遗忘的关系是什么？", options: ["A. 纪念越多遗忘越少", "B. 每一次纪念都隐含着一次遗忘——有选择地记住什么意味着同时决定不记什么", "C. 纪念和遗忘无关", "D. 遗忘是对纪念的破坏"], answer: "B", knowledgePoint: "纪念与遗忘", analysis: "英国有无数的二战纪念碑纪念阵亡士兵——但关于殖民地战争、关于殖民暴行的纪念碑在哪里？纪念的选择本身就是一个政治行为。" },
  ...
  { lesson: 66, title: "论点构建", questions: [
    ...
    { type: "choice", difficulty: 1, text: "以下哪个句子是一个真正的历史论点？", options: ["A. '二战于1939年爆发'", "B. '纳粹政策是欧洲犹太人遭系统性灭绝的核心原因'（有争议性的因果主张）", "C. '二战很重要'", "D. '希特勒是德国人'"], answer: "B", knowledgePoint: "什么是论点", analysis: "论点是有争议性的主张——别人可以和你辩论。纳粹政策是否'核心原因'是可以争论的，这使它成为论点而非事实陈述。" },
    ...
    { type: "choice", difficulty: 2, text: "有力的历史论点应该具备什么特征？", options: ["A. 模糊笼统以免被批评", "B. 明确、具体、可论证", "C. 尽可能长", "D. 只使用形容词"], answer: "B", knowledgePoint: "论点的特征", analysis: "'工业革命改变了英国'——太模糊。'工业革命在1780-1850年间通过技术创新和劳动力重组重构了英国社会阶级结构'——这才是一个有力的论点。" },
  ...
  { lesson: 67, title: "证据筛选", questions: [
    ...
    { type: "choice", difficulty: 1, text: "筛选历史证据的两个核心标准是：", options: ["A. 数量多、年代久", "B. 相关性、可靠性", "C. 篇幅长、知名度高", "D. 文笔好、故事性强"], answer: "B", knowledgePoint: "筛选标准", analysis: "相关性——这条证据和我的论点有什么关系？可靠性——这条证据的来源可信吗？有没有偏见？" },
    ...
    { type: "choice", difficulty: 2, text: "引用规范最重要的意义是什么？", options: ["A. 增加论文长度", "B. 尊重知识产权并让论点可被读者独立验证", "C. 显示自己读了很多书", "D. 避免抄袭指控"], answer: "B", knowledgePoint: "引用规范的意义", analysis: "引用规范表明'这个观点来自某人'——同时让任何人都能追溯你的证据链，验证你是否正确使用了它。" },
  ...
  { lesson: 68, title: "历史写作风格", questions: [
    ...
    { type: "choice", difficulty: 1, text: "好的学术语言应该是什么样的？", options: ["A. 越复杂越好，显示水平", "B. 准确、清晰、简洁", "C. 多用形容词", "D. 每个句子都超过50个字"], answer: "B", knowledgePoint: "学术语言标准", analysis: "准确——用词精确；清晰——一遍就能读懂；简洁——不用不必要的词。读者应该能在一遍内理解你的意思。" },
    ...
    { type: "choice", difficulty: 2, text: "'显然，一战完全是德国的错误'——这句话在历史写作中有什么问题？", options: ["A. 太短了", "B. '显然'假装论点不言而喻不需要论证，'完全'过度确定", "C. 没有语法错误就没问题", "D. 不应该写德国"], answer: "B", knowledgePoint: "避免的写法", analysis: "'显然'暗示论点是不言而喻的——但历史中没有不言而喻的事，每个判断都需要论证。'完全'排除了其他可能性——但历史的复杂性很少允许'完全'。" },
  ...
  { lesson: 69, title: "反驳与综述", questions: [
    ...
    { type: "choice", difficulty: 1, text: "一篇好的历史论文应该如何处理与自己论点相反的证据？", options: ["A. 忽略它", "B. 正面承认并回应，从而深化论证", "C. 隐藏它", "D. 长篇大论地指责对方"], answer: "B", knowledgePoint: "处理相反证据", analysis: "最有力的策略是正面回应——'某学者认为X，但……'——这向读者展示你了解这个争议，并且有能力处理它。" },
    ...
    { type: "choice", difficulty: 2, text: "好的史学综述应该达到什么效果？", options: ["A. 列出所有读过的书名", "B. 描绘一张'学术地图'——主要争论线、不同立场、发展趋势", "C. 只引用支持自己的学者", "D. 尽量简短不要给人挑错的机会"], answer: "B", knowledgePoint: "好综述的标准", analysis: "好的综述让读者看到：你的研究处于什么学术背景里、你要回应哪个争议、你想补充什么没有被充分研究的角度。" },
  ...
  { lesson: 70, title: "A-Level综合模拟", questions: [
    ...
    { type: "choice", difficulty: 1, text: "A-Level考试中最重要的是什么？", options: ["A. 记住所有日期", "B. 提出清晰论点并用证据支撑", "C. 写得越长越好", "D. 使用生僻词汇"], answer: "B", knowledgePoint: "A-Level要点", analysis: "A-Level考的不是你知道多少——是你思考得多清晰。提出论点、用证据支撑、回应反驳——比罗列事实重要得多。" },
    ...
    { type: "choice", difficulty: 2, text: "A-Level考试中时间管理的正确策略是：", options: ["A. 把所有时间花在最擅长的题目上", "B. 合理分配时间，确保每道题都有充分作答", "C. 先做最容易的再做最难的", "D. 不管时间，写满为止"], answer: "B", knowledgePoint: "时间管理", analysis: "一道完美的答案加两道草草结尾的答案，不如三道都有清晰结构的答案——总分是跨题目累加的。" },
