...
export const questionBank = [
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "地壳的平均厚度约为？", options: ['A. 约17千米', 'B. 约100千米', 'C. 约6371千米', 'D. 约1000千米'], answer: "A", knowledgePoint: "地壳厚度", analysis: "大陆地壳平均约33千米，大洋地壳平均约6千米，全球平均约17千米。" },
      { type: "choice", difficulty: 2, text: "下列哪对板块的边界是碰撞挤压型的？", options: ['A. 太平洋板块与北美板块', 'B. 印度洋板块与亚欧板块', 'C. 非洲板块与南美板块', 'D. 太平洋板块与纳斯卡板块'], answer: "B", knowledgePoint: "板块边界类型", analysis: "印度洋板块和亚欧板块碰撞形成了喜马拉雅山脉。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "下列哪种火山喷发最剧烈？", options: ['A. 盾状火山', 'B. 复合火山', 'C. 火山渣锥', 'D. 裂隙喷发'], answer: "B", knowledgePoint: "火山类型", analysis: "复合火山（成层火山）的岩浆黏度大，气体易聚集，喷发最剧烈。" },
      { type: "choice", difficulty: 2, text: "火山灰对全球气候的影响机制是？", options: ['A. 反射太阳辐射，降低气温', 'B. 吸收太阳辐射，升高气温', 'C. 增加降水量', 'D. 没有影响'], answer: "A", knowledgePoint: "火山灰对气候的影响", analysis: "火山灰进入平流层后反射太阳辐射，导致全球气温暂时下降。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "地震发生时，最先感觉到的是？", options: ['A. 上下震动', 'B. 左右摇晃', 'C. 先上下后左右', 'D. 先左右后上下'], answer: "C", knowledgePoint: "地震波", analysis: "纵波（P波）传播速度快，先到达，引起上下震动；横波（S波）后到达，引起左右摇晃。" },
      { type: "choice", difficulty: 2, text: "下列地区中地震最不活跃的是？", options: ['A. 日本', 'B. 印度尼西亚', 'C. 英国', 'D. 智利'], answer: "C", knowledgePoint: "地震带分布", analysis: "日本、印尼、智利都位于环太平洋地震带，英国位于板块内部，地震较少。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "下列哪个是岩浆岩？", options: ['A. 石灰岩', 'B. 花岗岩', 'C. 大理石', 'D. 砂岩'], answer: "B", knowledgePoint: "常见岩石类型", analysis: "花岗岩是岩浆在地下冷却形成的岩浆岩。石灰岩是沉积岩，大理石是变质岩。" },
      { type: "choice", difficulty: 2, text: "在岩石循环中，沉积岩变成变质岩需要什么条件？", options: ['A. 风化和侵蚀', 'B. 高温和高压', 'C. 沉积和压实', 'D. 熔化和冷却'], answer: "B", knowledgePoint: "岩石转化条件", analysis: "沉积岩在地壳深处的高温高压下可以变成变质岩。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "河流上游的典型地貌是？", options: ['A. V形谷', 'B. U形谷', 'C. 三角洲', 'D. 冲积平原'], answer: "A", knowledgePoint: "河流地貌", analysis: "河流上游水流急，下切侵蚀形成V形谷。" },
      { type: "choice", difficulty: 2, text: "关于河流搬运作用，说法正确的是？", options: ['A. 只有悬浮一种方式', 'B. 流速越快，搬运能力越强', 'C. 搬运物都是细沙', 'D. 搬运与流速无关'], answer: "B", knowledgePoint: "河流搬运", analysis: "河流流速越快，携带的颗粒越大越多，搬运能力越强。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "世界上人口最多的国家是？", options: ['A. 中国', 'B. 印度', 'C. 美国', 'D. 印度尼西亚'], answer: "B", knowledgePoint: "人口最多的国家", analysis: "印度已超过中国成为世界上人口最多的国家。" },
      { type: "choice", difficulty: 2, text: "下列哪个地区人口最稀疏？", options: ['A. 西欧平原', 'B. 撒哈拉沙漠', 'C. 东亚沿海', 'D. 南亚恒河平原'], answer: "B", knowledgePoint: "人口稀疏区", analysis: "撒哈拉沙漠气候极端干旱，不适合人类居住，人口极为稀疏。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "下列属于乡村特征的是？", options: ['A. 高楼林立', 'B. 人口密度低', 'C. 交通拥堵', 'D. 商业发达'], answer: "B", knowledgePoint: "乡村特征", analysis: "乡村人口密度低，以农业活动为主，建筑物矮小分散。" },
      { type: "choice", difficulty: 2, text: "城市化水平通常用什么指标来衡量？", options: ['A. 城市人口占总人口的比例', 'B. 城市面积大小', 'C. 城市GDP', 'D. 城市数量'], answer: "A", knowledgePoint: "城市化衡量", analysis: "城市人口占总人口的比例是衡量城市化水平的常用指标。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "下列土地利用类型中面积最大的是？", options: ['A. 耕地', 'B. 林地', 'C. 建设用地', 'D. 草地'], answer: "B", knowledgePoint: "土地利用结构", analysis: "全球范围内林地面积最大，其次是草地和耕地。" },
      { type: "choice", difficulty: 2, text: "城市热岛效应的主要原因是？", options: ['A. 城市人口多', 'B. 混凝土和沥青吸收热量', 'C. 城市污染少', 'D. 城市绿化好'], answer: "B", knowledgePoint: "热岛效应", analysis: "城市的混凝土和沥青吸收大量太阳辐射热，导致城市温度高于郊区。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "第二产业主要包括？", options: ['A. 农业和渔业', 'B. 制造业和建筑业', 'C. 金融和教育', 'D. 医疗和旅游'], answer: "B", knowledgePoint: "第二产业", analysis: "第二产业包括制造业、建筑业、采矿业等。" },
      { type: "choice", difficulty: 2, text: "经济全球化对发达国家就业的影响是？", options: ['A. 制造业就业增加', 'B. 制造业岗位向发展中国家转移', 'C. 就业没有变化', 'D. 农业就业增加'], answer: "B", knowledgePoint: "全球化影响", analysis: "发达国家制造业岗位向劳动力成本更低的发展中国家转移，导致本国制造业就业减少。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在野外用指南针辨别方向，红色指针指向？", options: ['A. 南方', 'B. 北方', 'C. 东方', 'D. 西方'], answer: "B", knowledgePoint: "指南针定向", analysis: "指南针红色指针指向地理北极（实际上是地磁南极）。" },
      { type: "choice", difficulty: 2, text: "比例尺1:100000表示图上1厘米代表实际距离？", options: ['A. 1千米', 'B. 10千米', 'C. 100千米', 'D. 1000千米'], answer: "A", knowledgePoint: "比例尺换算", analysis: "1:100000表示图上1厘米=实际100000厘米=1千米。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"气候带划分：纬度与洋流的作用\"中，全球气候带的分布规律是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "全球气候带分布规律", analysis: "Global climate belt distribution rules are an important part of geography." },
      { type: "choice", difficulty: 2, text: "以下关于\"纬度对气候的影响\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "纬度对气候的影响", analysis: "Understanding the impact of latitude on climate requires combining it with actual geographical environments." },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"季风系统：降水的季节变化\"中，季风的形成原因是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "季风的形成原因", analysis: "季风的形成原因是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"亚洲季风的特点\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "亚洲季风的特点", analysis: "理解亚洲季风的特点需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"热带雨林：最高效的生态系统\"中，热带雨林的分布与特征是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "热带雨林的分布与特征", analysis: "热带雨林的分布与特征是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"物种多样性与生态位\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "物种多样性与生态位", analysis: "理解物种多样性与生态位需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"荒漠：极端环境的适应\"中，荒漠的分布与类型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "荒漠的分布与类型", analysis: "荒漠的分布与类型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"荒漠气候特征\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "荒漠气候特征", analysis: "理解荒漠气候特征需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"气候变化的证据与机制\"中，气候变化的观测证据是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "气候变化的观测证据", analysis: "气候变化的观测证据是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"温室效应的原理\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "温室效应的原理", analysis: "理解温室效应的原理需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"城市化进程：工业化与人口迁移\"中，城市化的定义与衡量是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "城市化的定义与衡量", analysis: "城市化的定义与衡量是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"城市化的阶段特征\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "城市化的阶段特征", analysis: "理解城市化的阶段特征需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"城市内部土地利用模型\"中，同心圆模型、扇形模型、多核心模型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "同心圆模型、扇形模型、多核心模型", analysis: "同心圆模型、扇形模型、多核心模型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"城市功能分区\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "城市功能分区", analysis: "理解城市功能分区需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"逆城市化：为何人口向郊区迁移\"中，逆城市化的定义是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "逆城市化的定义", analysis: "逆城市化的定义是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"逆城市化的原因\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "逆城市化的原因", analysis: "理解逆城市化的原因需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"发展中国家的城市问题：贫民窟\"中，贫民窟的形成原因是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "贫民窟的形成原因", analysis: "贫民窟的形成原因是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"贫民窟的特征\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "贫民窟的特征", analysis: "理解贫民窟的特征需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"城市可持续发展案例\"中，可持续城市的特征是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "可持续城市的特征", analysis: "可持续城市的特征是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"绿色建筑与公共交通\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "绿色建筑与公共交通", analysis: "理解绿色建筑与公共交通需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"贸易网络：货物如何绕地球流动\"中，国际贸易的发展历程是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "国际贸易的发展历程", analysis: "国际贸易的发展历程是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"全球贸易路线\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "全球贸易路线", analysis: "理解全球贸易路线需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"跨国公司：全球工厂在哪里\"中，跨国公司的定义与特征是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "跨国公司的定义与特征", analysis: "跨国公司的定义与特征是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"跨国公司的区位选择\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "跨国公司的区位选择", analysis: "理解跨国公司的区位选择需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"旅游业的双刃剑：收入与破坏\"中，旅游业的经济贡献是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "旅游业的经济贡献", analysis: "旅游业的经济贡献是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"旅游对环境的影响\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "旅游对环境的影响", analysis: "理解旅游对环境的影响需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"文化全球化：本土文化的应对\"中，文化全球化的表现是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "文化全球化的表现", analysis: "文化全球化的表现是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"文化同质化与多样性\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "文化同质化与多样性", analysis: "理解文化同质化与多样性需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"全球发展不平等：中心与外围\"中，全球南北差异是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "全球南北差异", analysis: "全球南北差异是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"中心-外围理论\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "中心-外围理论", analysis: "理解中心-外围理论需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"热带气旋：能量来自温暖的海洋\"中，热带气旋的形成条件是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "热带气旋的形成条件", analysis: "热带气旋的形成条件是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"热带气旋的结构\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "热带气旋的结构", analysis: "理解热带气旋的结构需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"洪水：成因、影响与管理\"中，洪水的类型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "洪水的类型", analysis: "洪水的类型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"洪水的成因\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "洪水的成因", analysis: "理解洪水的成因需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"地震防灾：为何同震级损失不同\"中，地震灾害的影响因素是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "地震灾害的影响因素", analysis: "地震灾害的影响因素是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"建筑物抗震设计\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "建筑物抗震设计", analysis: "理解建筑物抗震设计需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"人类与灾害风险：脆弱性的地理\"中，灾害脆弱性的概念是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "灾害脆弱性的概念", analysis: "灾害脆弱性的概念是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"脆弱性的影响因素\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "脆弱性的影响因素", analysis: "理解脆弱性的影响因素需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"灾后重建：海地与日本的对比\"中，灾后重建的阶段是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "灾后重建的阶段", analysis: "灾后重建的阶段是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"不同国家的重建模式\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "不同国家的重建模式", analysis: "理解不同国家的重建模式需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"冰川作用：U形谷与冰碛物\"中，冰川的类型与特征是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "冰川的类型与特征", analysis: "冰川的类型与特征是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"冰川侵蚀作用\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "冰川侵蚀作用", analysis: "理解冰川侵蚀作用需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"风成地貌：沙漠中的风的雕塑\"中，风的侵蚀作用是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "风的侵蚀作用", analysis: "风的侵蚀作用是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"风积地貌\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "风积地貌", analysis: "理解风积地貌需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"喀斯特地貌：石灰岩的溶蚀\"中，喀斯特地貌的形成条件是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "喀斯特地貌的形成条件", analysis: "喀斯特地貌的形成条件是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"溶洞、石林、地下河的形成\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "溶洞、石林、地下河的形成", analysis: "理解溶洞、石林、地下河的形成需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"河流洪泛管理：硬措施与软措施\"中，防洪硬措施是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "防洪硬措施", analysis: "防洪硬措施是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"防洪软措施\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "防洪软措施", analysis: "理解防洪软措施需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"海岸侵蚀与防护：悬崖后退\"中，海岸侵蚀的原因是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "海岸侵蚀的原因", analysis: "海岸侵蚀的原因是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"海蚀地貌的类型\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "海蚀地貌的类型", analysis: "理解海蚀地貌的类型需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"发展的测量：GDP与HDI的差异\"中，GDP的定义与局限性是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "GDP的定义与局限性", analysis: "GDP的定义与局限性是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"HDI的构成\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "HDI的构成", analysis: "理解HDI的构成需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"贫困的成因与贫困陷阱\"中，贫困的定义与类型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "贫困的定义与类型", analysis: "贫困的定义与类型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"贫困陷阱的机制\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "贫困陷阱的机制", analysis: "理解贫困陷阱的机制需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"国际援助：援助的逻辑与批评\"中，国际援助的类型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "国际援助的类型", analysis: "国际援助的类型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"援助的理论基础\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "援助的理论基础", analysis: "理解援助的理论基础需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"新兴经济体：金砖国家的崛起之路\"中，金砖国家的特点是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "金砖国家的特点", analysis: "金砖国家的特点是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"经济增长的驱动力\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "经济增长的驱动力", analysis: "理解经济增长的驱动力需要结合实际地理环境来思考。" },
      { type: "open", text: "学了\"新兴经济体：金砖国家的崛起之路\"这一课后，你怎么看待这个知识在日常生活中的应用？请举例说明。", scoringPoints: ["能举出实际例子","能结合地理知识分析"], maxScore: 4 },
    ]
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"粮食安全：谁在挨饿，为什么\"中，粮食安全的定义是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "粮食安全的定义", analysis: "粮食安全的定义是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"粮食不安全的原因\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "粮食不安全的原因", analysis: "理解粮食不安全的原因需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"气候变化的影响：不均等的未来\"中，气候变化的区域差异是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "气候变化的区域差异", analysis: "气候变化的区域差异是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"脆弱地区的识别\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "脆弱地区的识别", analysis: "理解脆弱地区的识别需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"水资源争夺：稀缺与冲突\"中，水资源分布不均是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "水资源分布不均", analysis: "水资源分布不均是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"水资源冲突的案例\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "水资源冲突的案例", analysis: "理解水资源冲突的案例需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"生物多样性丧失的速率与原因\"中，生物多样性的价值是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "生物多样性的价值", analysis: "生物多样性的价值是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"物种灭绝的速率\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "物种灭绝的速率", analysis: "理解物种灭绝的速率需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"能源转型：可再生能源的地理\"中，可再生能源的类型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "可再生能源的类型", analysis: "可再生能源的类型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"可再生能源的地理分布\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "可再生能源的地理分布", analysis: "理解可再生能源的地理分布需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"可持续发展目标：2030年的承诺\"中，SDGs的背景与框架是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "SDGs的背景与框架", analysis: "SDGs的背景与框架是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"17项目标的相互关系\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "17项目标的相互关系", analysis: "理解17项目标的相互关系需要结合实际地理环境来思考。" },
      { type: "open", text: "学了\"可持续发展目标：2030年的承诺\"这一课后，你怎么看待这个知识在日常生活中的应用？请举例说明。", scoringPoints: ["能举出实际例子","能结合地理知识分析"], maxScore: 4 },
    ]
  },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"田野调查设计与实践\"中，田野调查的步骤是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "田野调查的步骤", analysis: "田野调查的步骤是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"数据收集方法\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "数据收集方法", analysis: "理解数据收集方法需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"GIS应用：空间数据的力量\"中，GIS的概念与功能是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "GIS的概念与功能", analysis: "GIS的概念与功能是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"空间数据类型\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "空间数据类型", analysis: "理解空间数据类型需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"数据统计与图表呈现\"中，描述性统计是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "描述性统计", analysis: "描述性统计是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"图表类型选择\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "图表类型选择", analysis: "理解图表类型选择需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"地理信息的批判性解读\"中，信息来源的可靠性是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "信息来源的可靠性", analysis: "信息来源的可靠性是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"地图的偏差\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "地图的偏差", analysis: "理解地图的偏差需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"GCSE综合复习\"中，核心概念回顾是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "核心概念回顾", analysis: "核心概念回顾是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"答题技巧\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "答题技巧", analysis: "理解答题技巧需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"大气层化学：温室气体的机制\"中，大气组成与结构是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "大气组成与结构", analysis: "大气组成与结构是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"温室效应原理\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "温室效应原理", analysis: "理解温室效应原理需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"海洋环流：热盐循环的全球意义\"中，海洋环流的驱动因素是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "海洋环流的驱动因素", analysis: "海洋环流的驱动因素是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"热盐循环的路径\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "热盐循环的路径", analysis: "理解热盐循环的路径需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      { type: "choice", difficulty: 1, text: "global carbon cycle的主要碳库不包括：", options: ["A. 大气圈", "B. 生物圈", "C. 地壳", "D. 岩石圈"], answer: "C", knowledgePoint: "碳库", analysis: "global carbon cycle主要碳库包括大气圈、生物圈、海洋和岩石圈。" },
      ...
      { type: "choice", difficulty: 1, text: "在\"碳循环与气候模型\"中，碳循环的过程是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "碳循环的过程", analysis: "碳循环的过程是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"碳汇与碳源\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "碳汇与碳源", analysis: "理解碳汇与碳源需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"极地冰芯：十万年的气候档案\"中，冰芯的形成与分析是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "冰芯的形成与分析", analysis: "冰芯的形成与分析是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"冰芯中的气候信息\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "冰芯中的气候信息", analysis: "理解冰芯中的气候信息需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"地球临界点：不可逆变化的阈值\"中，临界点的概念是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "临界点的概念", analysis: "临界点的概念是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"主要临界点识别\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "主要临界点识别", analysis: "理解主要临界点识别需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"移民与难民：驱动力与目的地\"中，移民的推拉因素是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "移民的推拉因素", analysis: "移民的推拉因素是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"难民危机的成因\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "难民危机的成因", analysis: "理解难民危机的成因需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"地缘政治：资源、领土与权力\"中，地缘政治的概念是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "地缘政治的概念", analysis: "地缘政治的概念是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"资源地缘政治\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "资源地缘政治", analysis: "理解资源地缘政治需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"资源战争：水、石油、稀土\"中，资源稀缺与冲突是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "资源稀缺与冲突", analysis: "资源稀缺与冲突是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"石油地缘政治\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "石油地缘政治", analysis: "理解石油地缘政治需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"城市贫民窟的非正规经济\"中，非正规经济的特征是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "非正规经济的特征", analysis: "非正规经济的特征是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"非正规经济的作用\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "非正规经济的作用", analysis: "理解非正规经济的作用需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"土著权利与土地所有权\"中，土著土地权利是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "土著土地权利", analysis: "土著土地权利是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"土地侵占与保护\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "土地侵占与保护", analysis: "理解土地侵占与保护需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"国际气候协议：《京都议定书》到《巴黎协定》中，气候协议的发展历程是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "气候协议的发展历程", analysis: "气候协议的发展历程是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"京都议定书的机制\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "京都议定书的机制", analysis: "理解京都议定书的机制需要结合实际地理环境来思考。" },
      { type: "open", text: "学了\"国际气候协议：《京都议定书》到《巴黎协定》这一课后，你怎么看待这个知识在日常生活中的应用？请举例说明。", scoringPoints: ["能举出实际例子","能结合地理知识分析"], maxScore: 4 },
    ]
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"水资源外交：跨境河流的谈判\"中，跨境河流的治理是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "跨境河流的治理", analysis: "跨境河流的治理是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"水资源外交案例\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "水资源外交案例", analysis: "理解水资源外交案例需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"北极资源争夺：融冰与新边界\"中，北极资源潜力是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "北极资源潜力", analysis: "北极资源潜力是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"北极地缘政治\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "北极地缘政治", analysis: "理解北极地缘政治需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"跨国污染责任：谁来承担\"中，跨国污染的类型是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "跨国污染的类型", analysis: "跨国污染的类型是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"污染责任的界定\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "污染责任的界定", analysis: "理解污染责任的界定需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"环境正义：污染总在穷人家门口\"中，环境正义的概念是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "环境正义的概念", analysis: "环境正义的概念是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"环境不平等的表现\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "环境不平等的表现", analysis: "理解环境不平等的表现需要结合实际地理环境来思考。" },
  ...
  // ════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"独立研究课题设计\"中，研究问题的提出是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "研究问题的提出", analysis: "研究问题的提出是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"研究设计\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "研究设计", analysis: "理解研究设计需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"混合方法研究：定量与定性\"中，定量研究方法是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "定量研究方法", analysis: "定量研究方法是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"定性研究方法\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "定性研究方法", analysis: "理解定性研究方法需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"地理写作：论证与证据\"中，学术写作规范是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "学术写作规范", analysis: "学术写作规范是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"论证结构\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "论证结构", analysis: "理解论证结构需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"数据解读的批判性思维\"中，数据的局限性是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "数据的局限性", analysis: "数据的局限性是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"偏见识别\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "偏见识别", analysis: "理解偏见识别需要结合实际地理环境来思考。" },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "choice", difficulty: 1, text: "在\"A-Level综合模拟\"中，知识整合是哪个方面的内容？", options: ["A. 地理学的核心概念","B. 历史学的记载","C. 物理学的计算","D. 化学的实验"], answer: "A", knowledgePoint: "知识整合", analysis: "知识整合是地理学的重要内容之一。" },
      { type: "choice", difficulty: 2, text: "以下关于\"综合题解题技巧\"的说法，正确的是？", options: ["A. 需要结合地理环境理解","B. 与具体情况无关","C. 只能从书本获取","D. 无法验证"], answer: "A", knowledgePoint: "综合题解题技巧", analysis: "理解综合题解题技巧需要结合实际地理环境来思考。" },
