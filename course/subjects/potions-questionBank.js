  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "A. 没有区别",
          "B. 变形魔药改变物质形态，变形术改变生物结构",
          "C. 变形术改变物质形态，变形魔药改变生物结构",
          "D. 只是名称不同"
        ],
        answer: "B",
    ...
    questions: [
      {
        ...
        options: [
          "A. 完全独立",
          "B. 草药学提供原材料，魔药学将其转化为药剂",
          "C. 魔药学提供原材料，草药学将其转化为药剂",
          "D. 两者没有关系"
        ],
        answer: "B",
    ...
    questions: [
      {
        ...
        analysis: "中级魔药开始强调材料之间如何互相增强、抵消或改变药性，而不只是照抄步骤。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "复方汤剂最能考验学生的哪项品质？",
        options: [
          "A. 精确和耐心",
          "B. 鲁莽",
          "C. 临时猜测",
        ...
        answer: "A",
        knowledgePoint: "复方汤剂",
        analysis: "复方汤剂需要长期熬制和严格材料处理，任何粗心都会影响身份转换效果。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "魔药效力除了配方，还会受什么影响？",
        options: [
          "A. 熬制者的专注度和操作稳定性",
          "B. 课桌高度",
          "C. 袍子颜色",
        ...
        answer: "A",
        knowledgePoint: "魔药效力",
        analysis: "火候、搅拌、时间和熬制者是否专注，都会影响成品效力。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "心理类魔药",
        analysis: "欢欣剂、镇定剂、遗忘药水等都说明魔药可以影响心理和认知层面。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "情绪魔药伦理",
        analysis: "情绪魔药可以缓解痛苦，也可能被滥用于控制他人，因此必须有明确边界。"
      },
      {
        type: "choice",
        difficulty: "hard",
        text: "未经同意使用影响心智的魔药，最大问题是：",
        options: [
          "A. 侵犯个体意志",
          "B. 药瓶不好看",
          "C. 价格太高",
        ...
        answer: "A",
        knowledgePoint: "个体意志",
        analysis: "影响心智的魔药触及人的自主性，未经同意使用属于严重侵犯。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "事故处理顺序",
        analysis: "魔药事故处理的第一步是停火和隔离，避免反应继续扩大；之后才进行救治和记录。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "D",
        knowledgePoint: "事故复盘",
        analysis: "材料批次、加热时间和搅拌方式都能帮助追溯事故原因；学院颜色与事故判断无关。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "急救材料",
        analysis: "白鲜香精常用于止血和促进伤口愈合，是魔药教室应随手可取的急救用品。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "O.W.L.评分",
        analysis: "O.W.L.不仅看成品，也看步骤、卫生、安全和记录。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "考试中发现材料明显变质，正确做法是：",
        options: [
          "A. 停下并报告",
          "B. 偷偷加倍用量",
          "C. 假装没发现",
        ...
        answer: "A",
        knowledgePoint: "考试安全",
        analysis: "发现材料异常应立即报告。硬着头皮熬制可能产生危险，也会影响评分。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "只背配方而不理解原理的最大问题是：",
        options: [
          "A. 无法处理变化和异常",
          "B. 字迹不好看",
          "C. 药瓶不够漂亮",
        ...
        answer: "A",
        knowledgePoint: "配方理解",
        analysis: "魔药考试会考查对材料、温度、顺序的理解；只背步骤很难应对异常情况。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "生死水效果",
        analysis: "生死水是强效昏睡剂，可使服用者进入近似假死的深度睡眠。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "混血王子处理瞌睡豆的改良思路是：",
        options: [
          "A. 挤压而不是直接切碎",
          "B. 完全不使用瞌睡豆",
          "C. 用火烧成灰",
        ...
        answer: "A",
        knowledgePoint: "材料处理",
        analysis: "挤压瞌睡豆能更好释放汁液，使药性更柔顺，是著名的改良处理方式。"
      },
      {
        type: "choice",
        difficulty: "hard",
        ...
        answer: "A",
        knowledgePoint: "强效魔药安全",
        analysis: "强效昏睡剂必须记录剂量、时间和体征，并准备唤醒方案，避免治疗变成危险。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "治疗魔药",
        analysis: "强效提神药剂可帮助重伤或虚弱者恢复体力，常与其他治疗手段配合。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "白鲜香精",
        analysis: "白鲜香精是校医室常见治疗药剂，用于处理伤口、止血并降低感染风险。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "医疗协作",
        analysis: "医疗咒语常处理即时危险，魔药提供持续恢复，两者应配合使用。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "曼德拉草复活药剂",
        analysis: "所谓复活药剂指解除石化状态，并不是真正起死回生。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "材料成熟度",
        analysis: "只有完全成熟的曼德拉草生命力稳定，才能用于解除石化。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "这类药剂最能体现哪两门课的交叉？",
        options: [
          "A. 草药学与魔药学",
          "B. 飞行课与天文学",
          "C. 魔法史与占卜",
        ...
        answer: "A",
        knowledgePoint: "跨学科魔药",
        analysis: "曼德拉草复活药剂依赖草药学材料培育，也依赖魔药学熬制。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "D",
        knowledgePoint: "魔药定价",
        analysis: "材料、难度和需求都会影响价格；坩埚颜色不应成为定价依据。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "商业化规范",
        analysis: "商业魔药必须稳定可复现，并清楚标注用途、剂量和保存条件。"
      },
      {
        type: "choice",
        difficulty: "medium",
        text: "自制魔药与购买魔药的合理比较应包括：",
        options: [
          "A. 成本、时间和品质保证",
          "B. 店主发型",
          "C. 包装颜色",
        ...
        answer: "A",
        knowledgePoint: "自制与购买",
        analysis: "自制和购买各有优缺点，应比较成本、时间、品质保证与风险。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "医疗配合",
        analysis: "医疗咒语常快速止血、复位或稳定伤情，魔药则提供后续恢复。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "D",
        knowledgePoint: "校医室药剂",
        analysis: "福灵剂稀有且有滥用风险，不会作为校医室常备药。"
      },
      {
        type: "choice",
        difficulty: "hard",
        ...
        answer: "A",
        knowledgePoint: "用药判断",
        analysis: "病人的体质、过敏、旧伤和用药情况都会影响魔药反应。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "A",
        knowledgePoint: "配方创新",
        analysis: "安全的配方创新要有原理依据、过程记录和效果验证。"
      },
      {
        type: "choice",
        difficulty: "medium",
        ...
        answer: "A",
        knowledgePoint: "材料替代",
        analysis: "替代材料可能降低效力或增加副作用，必须如实记录。"
      },
      {
        type: "choice",
        difficulty: "hard",
        ...
        answer: "A",
        knowledgePoint: "魔药判断力",
        analysis: "高级魔药学习不只追求技术，更要求知道何时能用、何时不能用。"
      }
    ]
  },
  {
