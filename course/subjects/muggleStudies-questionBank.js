...

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "请从历史角度分析：巫师与麻瓜关系从古代「相互协作」演变为「彻底隐藏」的根本原因是什么？这一变化对两个世界各自产生了怎样的深远影响？",
        knowledgePoint: "历史演变与影响",
        analysis: "参考要点：①古代合作的基础（疾病、农业、自然灾害等共同威胁）；②转折的触发因素（中世纪猎巫、信任崩溃、对魔法的恐惧）；③对巫师世界的影响（独立发展、与麻瓜科技脱节）；④对麻瓜世界的影响（失去魔法辅助、独立发展科技）。论述应体现因果逻辑，不能仅罗列事实。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "试描述一个巫师在麻瓜世界中可能遭遇误解的具体场景，并分析：这一误解的心理根源是什么？巫师应如何调整自己的行为方式（不使用魔法）来化解它？",
        knowledgePoint: "跨文化心理与沟通",
        analysis: "参考要点：①场景描述需具体（例如：不懂信用卡的巫师、对电话感到困惑等）；②心理根源分析（麻瓜的「正常」预期被打破，产生警惕）；③化解方案需符合麻瓜逻辑（用他们能理解的理由解释，而非魔法）；④体现对麻瓜社会规范的理解。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "假设你作为一名魔法部研究员，需要观察麻瓜社区以研究其社会结构，但又不能暴露魔法身份。请设计一套符合伦理规范的研究方案，并说明你如何在「获取有效数据」与「尊重麻瓜隐私」之间取得平衡。",
        knowledgePoint: "研究伦理与实践设计",
        analysis: "参考要点：①研究目的明确（研究什么，为什么）；②方法合理（公开参与观察、文献分析、访谈等非侵入手段）；③隐私保护措施（匿名化、不记录私人信息）；④如何避免魔法「作弊」捷径（如使用隐身咒偷听）；⑤研究成果如何反哺政策。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "O.W.L.麻瓜研究考官给出以下场景：「一位年老的麻瓜老太太因为街上的一场奇怪闪光而感到恐惧，向路人寻求解释。」请以一名普通麻瓜的视角（不暴露魔法身份），给出一段安抚她的合理回应，并在括号内说明你为什么选择这样的解释。",
        knowledgePoint: "O.W.L.案例分析实操",
        analysis: "参考要点：①回应要符合麻瓜逻辑（电线老化、汽车反光、施工电弧等）；②语气温和、令人信服；③不能提到魔法或任何超自然解释；④括号内说明理由需体现对麻瓜认知方式的理解（他们依赖「日常经验」解释异常）。"
      }
    ]
  },
...

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "请选择一个具体的麻瓜领域（如医学、心理学、工程学），详细阐述：它的哪些核心知识可以被引入魔法实践，具体如何改进现有的魔法方法，以及引入过程中可能面临哪些挑战？",
        knowledgePoint: "跨学科知识迁移",
        analysis: "参考要点：①选择的领域与分析具体（不能泛泛而谈）；②迁移逻辑清晰（为什么这个知识对魔法有用）；③改进效果有依据；④挑战分析真实（如魔力干扰精密仪器、伦理问题、知识鸿沟等）；⑤论述层次分明。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "近年来魔法部收到报告：某麻瓜城市中有数十名市民目击了一场扫帚飞行事件，记录视频已在麻瓜社交网络上传播。作为麻瓜联络办公室的新任分析师，请起草一份简短的「事件处置建议备忘录」，说明你推荐的应对策略及理由。",
        knowledgePoint: "政策应用与危机处置",
        analysis: "参考要点：①事件评估（传播范围、可信度、紧迫性）；②推荐策略需合理（如记忆改造的限制与适用条件、媒体层面的澄清途径）；③权衡各方利益（保密法要求 vs. 大规模记忆改造的伦理风险）；④格式应像真实备忘录（简洁、有条理、明确建议）。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "有观点认为：「随着麻瓜科技的高速发展，保密法迟早会被自然瓦解——巫师根本无法阻止所有摄像头和传感器。」请就这一观点发表你的看法，并论述麻瓜研究在「后保密时代」将扮演什么角色。",
        knowledgePoint: "未来展望与学科价值",
        analysis: "参考要点：①对该观点的分析（赞同、反对或折中，需有论据）；②「后保密时代」的可能情景（渐进式公开 vs. 突然暴露）；③麻瓜研究在其中的作用（文化桥梁、政策顾问、跨种族理解）；④论述应体现批判性思维，不能只提乐观愿景。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "请为「巫师与麻瓜文化交流节」设计一个为期一天的活动方案：活动在严格保密前提下举行，参与者为经过筛选的麻瓜志愿者（他们将被记忆改造）。说明你的活动设计思路、如何体现两种文化的平等性，以及最大的伦理风险是什么。",
        knowledgePoint: "跨文化交流方案设计",
        analysis: "参考要点：①活动设计具体可行（不能只说「展示魔法」，需有内容细节）；②平等性体现（不以「神奇」居高临下，也展示麻瓜文化的价值）；③伦理风险诚实分析（事后记忆改造是否真正「公平」？是否是一种欺骗？）；④能否提出改进保密框架的建议。"
      }
    ]
  },
...

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "麻瓜社会学研究表明，社会阶层会深刻影响一个人的世界观和行为方式。请分析：一个出生于麻瓜工人阶级家庭的巫师（如赫敏·格兰杰的父母那样的背景）与一个出生于上流社会麻瓜家庭的巫师，在理解麻瓜社会方面可能有哪些本质差异？这对麻瓜研究学者提出了什么要求？",
        knowledgePoint: "社会阶层与研究视角",
        analysis: "参考要点：①阶层差异的具体体现（经济焦虑、社会关系网络、对制度的信任度等）；②不同背景带来的研究视角偏差（上流社会视角可能美化不平等）；③对研究者的要求（自我反思、多元视角、田野调查而非书斋研究）；④论述应有深度，体现社会学思维。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "麻瓜物理学家提出「暗物质」和「暗能量」占宇宙总质能的95%，却至今无法直接探测。有魔法理论学者认为「魔力场」可能就是这种未知能量的一部分。请评估这一假说：它的论据是什么？最大的反驳是什么？如果这一假说成立，对魔法界和麻瓜科学界分别意味着什么？",
        knowledgePoint: "魔法与科学的理论交叉",
        analysis: "参考要点：①假说的论据（魔力的不可量化、超距作用特征等）；②反驳（暗物质有引力效应，与魔力特征不符；魔力需要施法者意图等主观因素）；③若成立的影响（魔界：可能失去神秘性；科学界：需重建物理框架）；④论述应展现N.E.W.T.级的思辨深度。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "请为以下假想研究设计一份简明的研究方法论框架：「调查在麻瓜家庭长大的巫师（如赫敏这类麻瓜出身学生）与纯血统巫师，在对麻瓜文化的理解上是否存在系统性差异」。你将使用哪些研究方法？如何确保研究的客观性？如何处理受访者的隐私与情感敏感性？",
        knowledgePoint: "研究方法论综合应用",
        analysis: "参考要点：①研究问题清晰定义（因变量：「理解程度」如何测量？）；②方法组合（问卷+访谈+标准化测试）；③客观性保障（匿名、双盲评分、对照组设置）；④伦理敏感性（纯血统问题涉及歧视，需注意措辞与匿名保护）；⑤研究局限坦诚承认（自我报告偏差等）。"
      }
    ]
  },

  {
    ...
    questions: [
      ...
      },
      {
        type: "open",
        difficulty: "hard",
        text: "N.E.W.T.论文题：伯比奇教授曾说「麻瓜也是人，和我们一样有感情、有梦想」。请以这句话为核心论点，结合你在麻瓜研究课程中学到的具体知识（至少引用三个不同领域的内容），写一篇完整的短论文（约300字），论证两个世界的「共同人性」及其对巫师社会的现实意义。",
        knowledgePoint: "N.E.W.T.综合论文",
        analysis: "参考要点：①论点明确，开篇即点题；②至少引用三个具体领域（如：麻瓜家庭结构中的亲情价值观、麻瓜艺术对情感的表达、麻瓜对教育的重视等）；③论据与论点的逻辑连接清晰；④结论有现实意义延伸（对魔法界政策、偏见消除等的启示）；⑤语言成熟，体现N.E.W.T.级学术写作能力。"
      }
    ]
  }
];