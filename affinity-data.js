...
export const AFFINITY_CHARACTERS = {
  sylviaMacmillan: {
    ...
    tierUnlocks: [null, '解锁：西尔维娅风格的课堂评语（更有个人感）', '解锁：偶遇事件「走廊上的十五分钟」', '解锁：个人故事碎片《她在伦敦的最后一年》', '解锁：专属信件 + 成就「你真的看见了」'],
    encounters: [{
      id: 'sylvia_enc_1',
      area: '教师办公室走廊',
      minTier: 2,
      text: '西尔维娅·麦克米兰站在走廊尽头，手里拿着一份表格，眉头微皱。她抬眼看到你，没有特别的表情。',
      choices: [{ label: '「教授，需要帮忙吗？」', delta: 3, response: '她看了你一秒。「不用。」然后顿了一下，「但……谢谢你问。」这是你第一次听她说谢谢。' }, { label: '点头走过', delta: 0, response: '她低头继续看表格。走廊里安静如常。' }]
    }, {
      id: 'sylvia_enc_2',
      area: '城堡图书馆',
      minTier: 3,
      ...
      choices: [{ label: '悄悄离开，不打扰她', delta: 2, response: '你轻声走开。第二天她在课上说了句话：「学会什么时候不打扰别人，也是一种能力。」你不确定是不是说给你听的。' }, { label: '走过去问她在读什么', delta: 4, response: '「一份1979年的田野报告。」她把封面翻给你看——是一个麻瓜社会学家写的伦敦贫困区观察。「他们从不假装事情不存在，」她说，「这一点值得学习。」' }]
    }, {
      id: 'sylvia_enc_3',
      area: '霍格沃茨大礼堂',
      minTier: 4,
      ...
      choices: [{ label: '点头回礼', delta: 2, response: '她的表情没有变化，但那个点头是真实的。' }, { label: '走过去坐到旁边', delta: 5, response: '「你吃饭了？」她没有转移话题的意思，只是问了一句最普通的话。你们就这么坐了十分钟，她没再说什么，你也没有。' }]
    }],
    story: {
      title: '她在伦敦的最后一年',
      unlockTier: 4,
      text: '1994年，西尔维娅·麦克米兰在伦敦的最后一年，她在一所中学做代课老师。她教历史。麻瓜历史。她的学生大多不喜欢历史。他们更喜欢体育课和午饭。西尔维娅每次批作业都批到很晚，不是因为作业多，是因为她想弄清楚每个孩子是怎么理解那些事情的。有一个叫达伦的男生，作文里写「工业革命让大家变富了」。西尔维娅在旁边写：「有人变富了。」达伦后来来问她。他们谈了将近一个小时。那年年末她收到邓布利多的邀请信。她回伦敦的最后一晚，去了达伦家附近的街道走了一圈。她没敲他家的门。她觉得她已经把她知道的最重要的东西留下来了。'
    },
    letter: {
      unlockTier: 5,
      text: '你收到一封没有信封的信，折叠放在你的课桌上。字迹是黑色墨水，笔压很重。「我不习惯写这种信。但我的一个学生告诉我，有时候你应该把你本来只在脑子里说的话写出来。你上个月说了一句话——\'麻瓜并不是因为没有魔法才值得被理解。\'我让你重复了一遍，你以为我没听清楚。我听清楚了。——麦克米兰」'
    }
  },
  augustusFenwick: {
    key: 'augustusFenwick',
    ...
    story: {
      title: '他唯一的遗憾',
      unlockTier: 4,
      text: '奥古斯都·芬威克从未在麻瓜世界长期生活过。这是他唯一的遗憾。他写《无魔之算》花了七年。所有数据来自魔法部档案室的麻瓜文献馆。他申请过麻瓜融入计划，被拒了两次，理由是「年龄偏大，适应风险较高」。第三次申请时，西尔维娅·麦克米兰已经加入霍格沃茨。她知道这件事，什么也没说。他在自己办公室里有一份1990年代的伦敦地图，是麻瓜版本，上面有地铁线路。他用红笔圈出了几个地方，没有标注名字。学生问过他为什么圈那些地方。他说：「想去看看。」那张地图一直在那里。'
    },
    letter: {
      unlockTier: 5,
  ...
  elizaLovegood: {
    ...
    story: {
      title: '没有魔力的魔法',
      unlockTier: 4,
      text: '伊莱莎·洛夫古德开这门课之前，没有人认为「语文与文学」应该是麻瓜研究系的必修内容。她花了三年说服西尔维娅·麦克米兰。不是用论文，是用一首诗。她把那首诗朗读给麦克米兰听——一首麻瓜诗人写的，关于失去一个人的感受。读完，她说：「这首诗没有魔力。但我读完它觉得某个东西改变了。你也是吧？」麦克米兰沉默了很长时间。「开课，」她最后说，「但你要能让学生感受到这个，不只是分析它。」伊莱莎每节课都闭眼朗读一首诗。不是表演，是因为她真的每次都在重新感受一遍。她说过：「文字是没有魔力的魔法。」她从不解释这句话是什么意思。'
    },
    letter: {
      unlockTier: 5,
  ...
  constanceShacklebolt: {
    ...
    story: {
      title: '不要同情，要理解',
      unlockTier: 4,
      text: '康斯坦丝·沙克博特在第一节课就说了这句话：「不要同情他们，要理解他们。同情是居高临下，理解才是平等。」这句话在麻瓜研究系内部引发了半个学期的讨论。赫伯特·宾斯二世认为她说得对但太冷。伊莱莎·洛夫古德认为理解和同情不是对立的。西尔维娅·麦克米兰没有表态，但在下一次课程委员会会议上，她引用了这句话。康斯坦丝自己的来历复杂——她的家族里有曾在魔法部做过联络官的长辈，见过太多「同情麻瓜」最后变成俯视麻瓜的例子。她不说这些。她只教学生怎么分析一个制度，怎么看见权力的结构，怎么在不带情绪的情况下理解一个和自己不同的世界。她课后和学生谈过最长的一次话：四个小时。那个学生后来在魔法部做了政策研究。康斯坦丝听说这件事时的反应是：「那很好。」'
    },
    letter: {
      unlockTier: 5,
  ...
  severusSnape: {
    ...
    story: {
      title: '半血王子的注脚',
      unlockTier: 4,
      text: '西弗勒斯·斯内普的父亲是麻瓜。他从不谈论这件事。麻瓜研究系档案室的借阅记录里有他的名字，借阅日期是深夜，归还日期是第二天清晨。他借过的书是麻瓜工业化学期刊和一本关于纺织工业的历史。西尔维娅·麦克米兰在一个深夜撞见了他手里拿着那本期刊从走廊走过。两个人对视了一秒，谁都没有开口。后来西尔维娅在内部学报的订阅名单上加了他的名字。他没有退订。他的课本里有几处空白处密密麻麻的注解，大多数是关于配方的，但有一条在某个关于麻瓜工业的注脚旁边写着三个字：「父亲厂。」那本课本现在在禁书区存档，没有人特别注意过那三个字。'
    },
    letter: {
      unlockTier: 5,
  ...
  minervaMcGonagall: {
    ...
    story: {
      title: '她的麻瓜父亲',
      unlockTier: 4,
      text: '米勒娃·麦格的父亲是麻瓜牧师。她从未在课堂上提过这件事。她比大多数霍格沃茨教授更了解麻瓜世界日常是什么样的——不是抽象的了解，是具体的：周日早上父亲讲道的样子，邻居们的名字，村子里谁家屋顶漏水。她和西尔维娅·麦克米兰每隔几个月喝一次茶，从不聊魔法部人事，只聊普通的事。在课程委员会，麦格从不主动发言支持麻瓜研究系，但她的投票从未偏离过西尔维娅的立场。西尔维娅知道这件事。她们从来没有互相提过。'
    },
    letter: {
      unlockTier: 5,
  ...
  rolandaHooch: {
    ...
    tierUnlocks: [null, '解锁：胡奇专属课堂互动', '解锁：偶遇事件「球场之后」', '解锁：个人故事碎片', '解锁：专属信件']
  },
  sybillTrelawney: {
    key: 'sybillTrelawney',
    name: '西比尔·特里劳妮',
...
export const CHARACTER_DISPLAY_ORDER = ['sylviaMacmillan', 'augustusFenwick', 'serafinaMoody', 'primroseSprout', 'tavishMacLaren', 'herbertBinns', 'constanceShacklebolt', 'felixWeasley', 'elizaLovegood', 'mirandaPercival', 'minervaMcGonagall', 'severusSnape', 'filiusFlitwick', 'pomonaSprout', 'rolandaHooch', 'sybillTrelawney', 'auroraSinistra', 'albusDumbledore'];

export const MUGGLE_STUDIES_ORDER = ['sylviaMacmillan', 'augustusFenwick', 'serafinaMoody', 'primroseSprout', 'tavishMacLaren', 'herbertBinns', 'constanceShacklebolt', 'felixWeasley', 'elizaLovegood', 'mirandaPercival'];
